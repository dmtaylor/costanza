...
/cursed-admin add:    add cursed words to the cursed word list for the current server
/cursed-admin remove: remove cursed words from the cursed word list for the current server
/cursed-admin list:   list the cursed words for the current server
` +
	"```"
