...
INSERT INTO quotes (quote) VALUES 
    ...
    ('20 thousand dollars?'),
    ('25 kids for his birthday party? Don''t put your tongue on the floor! He''s putting his tongue on the floor! Here, here, have some more sugar packets.'),
    ...
    ('9:45'),
    ('Aaaaaah'),
    ('Aaaa  Ah ha. They had plans huh? They were busy. They were busy with their  big plans!'),
    ('Aaahh!!'),
    ('A ah'),
    ('Aah! Fire!'),
    ('Aah, hey. If this works out, forget about it. Vacations together, movies together, dinner together. It...it''s almost as good as if I didn''t get married.'),
    ('Aahh...No...No...'),
    ('Aahhrghit wouldn''t take long pause, audience laughter) ten minutes from now, I''ll be sweating all over again ,I can feel it. I''m a human heat pump!'),
    ...
    ('A-and don''t settle for 145, you can do better, you''re a genius. Heheheh'),
    ('A-Anyway, I was thinking we would take two cars up to the cabin and that way if one of wanted to stay you know'),
    ...
    ('A bubble boy?'),
    ('A cane. I knew it. So, we meet at last. I admire your skills, Mr Peanut.'),
    ...
    ('After Dinkins lost the election, he had a complete nervous breakdown. They had to lock him up.'),
    ...
    ('A gymnast! I can''t believe it, you didn''t tell me she was a gymnast.'),
    ('ah.'),
    ('AH!'),
    ('A-ha.'),
    ...
    ('Ah, excuse me. When your, uh, when your wallet was open, I - I glanced inside, and I couldn''t help but notice that you have several crisp dollar bills.'),
    ('Ah, get outta here. The vomiting is much funnier.'),
    ('Ah, great. All right, with the wine I''m in over twenty dollars now.'),
    ('Ah, great, great. What''s that smell? Smoke? FIRE! FIRE! Get out of the way!'),
    ('ahh.'),
    ('Ahh!'),
    ('Ah-ha!'),
    ('Ah Ha.'),
    ...
    ('Ahh. Good for you.'),
    ('Ahh, Hey-Ho. ahhhhh'),
    ('Ahh, hey you''re home. Hi.'),
    ('Ahhhh, Ahh, Ah, Ahhh, Ahh, Ah!'),
    ('Ahhhhh'),
    ('ahhhhh  Jerry, my young friend, you''re so naive. You are so, so naive. You know about a few things. You know about comedy, a little bit about relationships, some baseball, but you are so far out of your element here, you are embarrassing yourself. Now listen to me. I''m negotiating. Negotiation, this is what''cha do in business.'),
    ('Ahhh. How does this thing work?'),
    ('Ahhhh, Yes! Touch down! Your turn, Jerry. (hands Jerry the Mattel Football. George starts playing with the Etch-a-sketch.)'),
    ('Ahh! How''d she look?'),
    ('Ahh, ladies, please, please.'),
    ('Ahh, money.'),
    ...
    ('Ah, I guess I showed Neil who''s Neil.'),
    ...
    ('ALL RIGHT!!'),
    ('All right, all right'),
    ('All right, All right, all, right!! How you gonna find out who this is?'),
    ...
    ('All right, do you mind? I have the window! Now, what are you gonna do about my Twix?'),
    ...
    ('All right, I''ll tell them my sister died. My poor sister died. She was standing and then she was laughing and then they SHOT her! That''s the kind of sick city that we''re livin'' in. They shoot you for laughing. I must go and comfort my poor family. Jerry, take me home so I can comfort my my poor family.'),
    ...
    ('All right, I''m gonna move my car, my meter''s up. Can''t park in this city.'),
    ('All right. I''m gonna try givin'' them fifty-five dollars each  What do you think?'),
    ...
    ('All right. Let me just say one thing: there is no way that this is gonna happen. You hear me? No Way! Because if you think I''m going'' to two Thanksgivings, you''re out of your mind!!!'),
    ('All right. Let''s get to work.'),
    ('All right, let''s go, let''s go, let''s go, come on.'),
    ...
    ('All right now we''re going bye bye.'),
    ...
    ('All right, shmoopieswhat''s it gonna be? Pick a theater.'),
    ...
    ('All right. That''s more like it. Thank you very much. By the way, my uncle was an alcoholic, so'),
    ('All right. There''s nothing to be worried about. She''s just a little annoyed right now. Tomorrow I''ll personally go over there. I''ll apologize. I''ll get the papers. Don''t worry. Don''t worry.'),
    ...
    ('All right You really want to know?It all started when she told met hatshe was the voice on your tape recorder.'),
    ...
    ('Alright.'),
    ('Alright?'),
    ('Alright. 7,7,  6. I''m not gonna eat that much!'),
    ('Alright, alright!'),
    ('Alright. Alright.'),
    ('Alright, alright, but no funny business, same deal as last night.'),
    ('Alright, alright. Can we go out and eat?'),
    ('Alright, alright, fine.'),
    ('Alright, alright! (Goes out onto the sidewalk. The Seinfelds walk by) Seinfelds!'),
    ('Alright, alright, hold on! Time out! Woah, woah! What did she say?'),
    ('alright alright, I gotta buy some bread'),
    ('Alright, alright, I''ll go on the date, but that''s that.'),
    ('Alright, alright. Look, we''re people, you and me, huh? Businessmen. Colleagues, if I may. Let''s not quibble. We''ll do it for the thirteen thousand. Thirteen thousand, and I never came up here, we never talked, alright. You take good care. It was nice seeing you again, and nice meeting you. Cynthia, right?'),
    ...
    ('Alright get out of my way. Alright don''t make me get physical here!'),
    ('Alright, here we go.'),
    ...
    ('Alright if you think it''s too much they don''t have to mail the postcards.'),
    ...
    ('Alright, I gotta try and talk my mother into taking him off my hands.'),
    ...
    ('Alright, I, I''ll just take fifty. Do - do we have a deal?'),
    ...
    ('Alright, now you''re gonna see some parallel parking. How I wish you could make a living parallel parking. It''s all geometry, knowing all the angles, when to make that first turn and then when to swing it back in, that''s the key.'),
    ...
    ('Alright, stop it Kramer, you''re freakin'' me out.'),
    ...
    ('Alright that''s it. So you get rid of me and now the two of you are going to sleep together?'),
    ...
    ('Alright, there you go. She''s gonna get the jacket back. So, let''s go get some coffee, huh?'),
    ...
    ('Alright, very good, very goodgo fold your little balloon animals, Eric. Eric! What kind of name is that for a clown, huh?'),
    ...
    ('Alright, whatever! Now. Whatever caused the damagewas jarring enough to completely stop the tape.'),
    ...
    ('And so, for all these reasons, we are officially broken up. and good night.'),
    ('and SUSAN:'),
    ('and SUSAN: The third?'),
    ...
    ('And, you know, I do a lotta business with Japanese TV. They broadcast a lot of American baseball. They got an office here in New York!'),
    ...
    ('Anyway, I just wanted to let you know I''m really sorry that happened, and if I can help out in any way, I''ll certainly be glad to do that. Well, I guess that''s about it.'),
    ...
    ('Are you insane? Jerk store, woulda smoked that guy! Smoked him, I say.'),
    ...
    ('Are you often on business trip? Niceoh, hey nice ice-bucket.'),
    ('Are you still down in the dumps? Come on. It''s just a chick.'),
    ('Are you supposed to yell it?'),
    ('Are you sure?'),
    ('Are you sure? ''Cause it could really help me out of a jam.'),
    ('Are you sure? Oh, look who I''m talking to. The president of NBC.'),
    ('Are you through?'),
    ...
    ('Argh! Susan! Hi! Oh, boy! What are you doing here?!'),
    ...
    ('Assistant to the travelling secretary. I''m uh, working on the project.'),
    ('A stock.'),
    ...
    ('As you will see, the candy bar is paid for, and yet, remains dangling in the machine. Hey, it''s gone. Where is my Twix? (Quickly looks around. His sights fall on the window of a door labeled ''Employees Only''. The same mechanic from before is eating a candy bar) What?! That guy''s eatin'' it!'),
    ('A table right here.'),
    ...
    ('Aw, hoh, oh Deena, thank God. Thank God you''re here. Listen, you gotta help me. You gotta tell these people that I''m okay. You know that I don''t belong in here.'),
    ...
    ('Because? Because?'),
    ('Because! Because, as the leaderif I diethen all hope is lost! Who would lead? The clown? Instead of castigating me, you should all be thanking me. What kind of a topsy-turvy world do we live in, where-where heroes are cast as villains? Brave men as cowards?'),
    ...
    ('Because he''ll know I told you. Besides, he''s giving me a parking spot around the corner for practically nothing.'),
    ...
    ('Because if she gets it back, then you''ll have no reason to be sour. You''ll de-sour, right?'),
    ('Because if there''s any doubt at all II feel we should cultivate it.'),
    ...
    ('Because I like this one! C''mon, let''s go. Let''s go! Oh, hi.'),
    ...
    ('Besides, Steven Koren has the highest of aspirations. He wants to be  an architect.'),
    ...
    ('But enough about fish, huhuhu. I can discuss other things you know, ah architecture. Huhu.'),
    ('But happy.'),
    ...
    ('But if you think about it26 teams, 162 games a season, you''d think eventually an entire team would get wiped out.'),
    ...
    ('But you didn''t use a coaster, Jerry, you left a stain!'),
    ...
    ('Bye, thanks. I can''t believe she took the money.'),
    ...
    ('Cause it''s signals, Jerry, it''s signals! Don''t you- all right. Did she even ask you, what you were doin'' tomorrow night, if you were busy?'),
    ...
    ('Chinese food!'),
    ('Chinese food?'),
    ('Chocolate chip mint? Oh well, actually Jerry I prefer chocolate chip. What is it about the chocolate and the mint that makes it go so well together?'),
    ...
    ('Clearer'),
    ('Clint Eastwood!'),
    ('Clock over there. O''Brien.'),
    ('Clothes shopping.'),
    ('C''mon.'),
    ('C''mon, c''mon See, now, is that so bad?'),
    ...
    ('Coco?'),
    ('Coffee? I can beat that. Move in with me.'),
    ...
    ('Could you ask her, just ask her. If she says no, case closed.'),
    ('Could you make it two-twenty-five that was his hi-game in bowling.'),
    ('Could you put a little thought into this? Jerry''s gone, you could humour me. He humours me.'),
    ('Course, I wouldn''t, I mean uh, the guy is uh, well obviously  the guy has his problems.'),
    (' ''course not'),
    ...
    ('Danielle. Where''s Neil? Is this him?'),
    ...
    ('Did you feel that tension? We use to have banter -  - there''s no more banter.'),
    ...
    ('does not imply transfer of ownership. Moe, Sol, or Lem is not gonna get away with this!'),
    ...
    ('D''ohOh, oh, the judge! I hate this guy!'),
    ...
    ('Don''t jinx it! Don''t jinx'),
    ('Don''t leave'),
    ('Don''t look around. Don''t look around. That''s what he wants.'),
    ('Don''t need it. N''huhuhu'),
    ('Don''t tell her anything, she''ll kill me!!'),
    ...
    ('Do you, uh  do you know what I''m  thinking about now?'),
    ...
    ('D''you ever had a Macanaw peach?'),
    ('Early! Alright! Cold.'),
    ('Eat me alive, huh? We''ll see who can make it in *this* town.'),
    ('Ech. What else you got?'),
    ('Eee-aaa-eee-aaa-eee-aaa'),
    ('Eggs are eggs. That is very profound. (laughs; Daphne goes back to reading her paper) By the same token you could say fish is fish. Ha ha ha, I don''t think so. Listen Dophne'),
    ...
    ('Ehcome oooon(starts stabbing the paper with the pen. Mr. Wilhelm comes in)'),
    ('Eh, don''t mention it.'),
    ...
    ('ehh. So what made you change your mind?'),
    ...
    ('Eh, they''re trying to pick out a new couch - you don''t want to know. Give me your wallet, or I''ll spill your guts right here on the street!'),
    ('Eighteen dollars.'),
    ('Eight o''clock.'),
    ...
    ('Elaine.'),
    ('Elaine?'),
    ('Elaine and her spongesshe''s got like, a war chest full of them.'),
    ('Elaine, bald men, with no jobs, and no money, who live with their parents, don''t approach strange women.'),
    ('Elaine? Can I come?'),
    ('Elaine, can I just explain something to you very privately here? Susan and I have been together many, many times now, and just between you and me, there''s really no big surprises here, somake-up sex is all that I have left.'),
    ('Elaine, c''mon. Would you just make the call? Please, make the call.'),
    ...
    ('Elaine? It''s me, George. Hey, sorry to bother you so late. Hey! How ya doin.''  Uh, did you get any of those sponges?'),
    ('Elaine, Julie.'),
    ('Elainelet me just explain something to you. See, this is not just a weekend routineI''m on the verge of make-up sex here. You know about make-up sex?'),
    ...
    ('Elaine, this pilotit doesn''t matter to me, it''s not me I''m concerned aboutit''s my mother. I''ve been over to the hospital to see her'),
    ...
    ('Elaine! You have got to get me Marisa Tomei''s phone number!'),
    ...
    ('Every five years!'),
    ('Every night at six-thirty. The nurse was gorgeous... then I got a look at the patient... I was going nuts.'),
    ...
    ('Excuse me, do you see anything on my lip here?'),
    ('Excuse mehuh I think I made a big mistake. I''d like my deposit back please.'),
    ...
    ('Excuse meI really What''s happened is that my friend forgot where he parked and if you''re not in a big hurry, we''d really appreciate it if'),
    ...
    ('Feels right.'),
    ('Feel? What''s that?'),
    ('Felt like it. I tell you, this doll is pretty spooky. It''s freakin'' me out man. And now I got to go back out there and pick up this doormat.'),
    ...
    ('Fine, fine.'),
    ('Fine. Fine. Excuse me. Think I''m gonna forget about this? I haven''t forgotten about this. I don''t forget that easily!'),
    ...
    ('Five thousand dollars? She doesn''t have five thousand dollars!'),
    ...
    ('George, don''t make me get tough with you.'' Whu, hu, hu, hu huuuu  Who says that? She is really cool. What do you think? You think she likes me?'),
    ('George, George Costanza!'),
    ('George, how you doing?'),
    ('George is getting upset...'),
    ('George is going to the movies!'),
    ('George is in big trouble.'),
    ('(George is telling a story. Karen is laughing and she seems to be the only one to find him funny) So I go into this clothing store and the saleswoman is wearing this  low cut thing. So I said to her: ''Can I ask you a question? When you put on a top like that, what''s your tought process? What''s going on in your mind?'),
    ...
    ('Get a good night''s sleep, alright fellas. Big day tomorrow!'),
    ('?? get away??'),
    ...
    ('Give it! Give it! Pinheads.'),
    ('Give me one.'),
    ('Give me the phone!'),
    ('Give me the phone. Yea, Hi I would like to speak to Patrice. what? oh really? oh, ok, thank you,'),
    ('Give me two bucks. I''ll do it for two bucks.'),
    ('Give me your key, I gotta get it.'),
    ('Glad you enjoyed it.'),
    ('Glenda, can I ask you a favor? Can I have this seat?'),
    ('Go back?'),
    ('God bless you.'),
    ...
    ('Good Morning!'),
    ('Good morning. Good morning. Good morning. Hi nice to see you. How are you. Good morning. Good morning.'),
    ...
    ('Got it.'),
    ('Got it. Did you just see what happened here?'),
    ('Got it, Got it,Hello?'),
    ...
    ('Great, great. O-Oh, oh, oh, gosh. You know, it''s just my duties with the Yankees'),
    ('Great, great. So anytime you want you can just visualize her naked.'),
    ('Great! I ate the entire platter! Had to call in sick today.'),
    ('Great. Jerry, I gotta tell you, I had the BEST TIME with that Nina last night. I - I think I''m in love with her already. You are a great friend. A great, great friend.'),
    ('Great move, telling him, by the way, real smart move.'),
    ('Great news! I showed the pilot to Kramer''s Japanese friends. They loved it!'),
    ('Great! Nina could go, huh? Jerry, this is great. You and Elaine. Me and Nina.'),
    ('Great! Now she''s sour!'),
    ('Great. Oh, by the way, did you get a chance to read the script?'),
    ('Great. Seven-thirty, alright?'),
    ('Greetings, people. Greetings. Greetings and salutations. What a beautiful day for a ball game. Let''s play two! Oh, I''ll have the chicken salad on rye, my usual, you know what I get, darlin''. he''s the first base man.'),
    ('Guess not.'),
    ...
    ('Ha! Can you believe it? I''m supposed to be havin'' lunch with her right now at Pomodoro.'),
    ...
    ('Ha, ha, ha, ha! (The Twix gets stuck in the spindle right before falling. George begins to pound the machine) Come on! Jump!'),
    ('Ha-ha-hah. This is my lucky day.'),
    ...
    ('Ha... She''ll have to find me first.'),
    ...
    ('(Heavily sarcastic. He''s angered at Jerry) Good one. Very funny. You''re very funny, Jerry. That''s what I always tell people. Jerry Seinfeld''s a funny guy!'),
    ('He called in sick.'),
    ...
    ('He dropped it.'),
    ('He eats those?'),
    ('he embibed her glistening spelljust before the other shoefell.'),
    ('He fired me.'),
    ('He forced me to!'),
    ('He frolfs, he scores'),
    ('He gave me a wedgie.'),
    ...
    ('he he'),
    ('Hehee. We could be like the Gatsbys. Didn''t they always like, you know, a bunch of people around, and they were all best friends?'),
    ('Hehehe. .'),
    ('He he he he'),
    ('Hehehehehe'),
    ('he...he''s alive'),
    ('He heSo huh! What''s with the suitcase.'),
    ('He he This guy really gets around.'),
    ('He...He threatened me.'),
    ('He...he wants to talk to me?'),
    ('He-he was uh touching and rubbing.'),
    ('Hehe. Well, I got my triangles.'),
    ('Heh, haa. And that''s no good. I''ve tried it straight, Jerry. We''ve all seen the results. For me, sick is the only way to go.'),
    ('Heh heh.'),
    ('Heh heh heh hey, new suit'),
    ('Heh heh heh So side-splittingly funny'),
    ('Heh, heh, heh. That''s what they want you to think.'),
    ('Heh he, I made it.'),
    ('Heh, Mercury head. You mind?'),
    ('He...hmmm. hummWhat about this one.'),
    ('Heh, that''s right. See ya later.'),
    ('Hehummm , Yeah!'),
    ('Heh. You seem like you really enjoyed your Risotto. You have a very contented air over there. You look very contented, very satisfied. Are you satisfied?'),
    ('He is. You don''t know what I''m doin'' here.'),
    ('He jumps!'),
    ('He just read it. (Russell vomits again. Jerry and George look ashamed.)'),
    ('He just walked away! And once again I''m standing here like a little man. Well not this time! You! Dog man!'),
    ('He knows.'),
    ('He knows?'),
    ('He knows how to read. And he also knows finishing an entire book doesn''t prove anything. And get this: he''s into architecture.'),
    ...
    ('Hello? Amanda. Hi, yes. Listen. You know, I''m thinkin'', we might just be better of bein'' friends. Yeah. Yeah, you know what, I can''t even really talk about it right now. Bye-bye. No! No!'),
    ('Hello everybody.'),
    ...
    ('here Elaine here, Superman  please, next time it will only be the two of us'),
    ('Here it comes.'),
    ('Here, just give me a couple of napkins.'),
    ('Here. Let me take your tabe downstairs for you.'),
    ('Here''s my card. I''m in real estate, so, if you''re ever looking for something bigger, something nicer... maybe not right now. Anyway... (Extends his hand for a handshake. Antonio doesn''t move)'),
    ('Here  something.'),
    ...
    ('He said that? What a nerve. How dare he say something like that.'),
    ('He said what?'),
    ('He''s a jerk.'),
    ('He''s alright?'),
    ('He''s an importer.'),
    ...
    ('He''s an importer/exporter, okay? Elaine ever call you back?'),
    ...
    ('He''s getting on a bus, damn! Those are nice glasses.'),
    ...
    ('He uhdoesn''t have any running water?'),
    ...
    ('Hey, at least I''m bringing something to this. Nope. Woah, something from Whatley.'),
    ...
    ('Hey, check this out. I gotta give out Christmas presents to everyone down at Kruger, so I''m pulling a Whatley.'),
    ('Hey. Corbin Bernsen.'),
    ('Hey, Cosmo what happened to your mother last night. She hung me out to dry.'),
    ('Hey could you do one other thing for me?'),
    ('Hey Deena, come on, give us a hug. Oh my gosh, you look as pretty as you did back in high school.'),
    ...
    ('Hey Elaine. I''m telling you Jerry, having a secretary is incredible. I don''t know why I didn''t have one before.'),
    ...
    ('Hey Glenn!'),
    ('Hey, go.'),
    ('Hey, grown-up. Oh my god, there she is. Go ahead, go ahead. Let''s go, let''s go. All right what are they saying?'),
    ...
    ('Hey, hey, it''s George, I need ya to do me a favor.'),
    ...
    ('Hey, hey! Yankee game!'),
    ('Hey, hey! You can''t believe this. Look at this check! They told me I had the most beautiful hands they''d ever seen in their lives - except for this McKigney guy - this great looking girl gave me her phone number... I got it! I got it all! I''m busting. Jerry, I''m busting!'),
    ('Hey! Hey, you! Come back here!! Don''t gallop away!!'),
    ...
    ('Hey. I gotta go.'),
    ('Hey, I htink I may have found someone for the scholarship.'),
    ...
    ('Hey listen umm, instead of the movie uh, maybe we''ll go back and uh you know'),
    ...
    ('Hey, Mr Seinfeld. Hey, Mrs Seinfeld. How are you?'),
    ('hey nice move today'),
    ('Hey, Nina! I owe you some money, don''t I?'),
    ('Hey, now you''re onto something.'),
    ('Hey oh.'),
    ('Hey oo, I just remembered uh my parents really wanna have you guys over for dinner before you leave town. What about tonight?'),
    ...
    ('Hey, whatd''ya know? Look at that! A *lesbian* sighting. Oh-ho! My lucky day. They''re *so* fascinating. Why is that? Because they don''t want us. You gotta respect that'),
    ...
    ('Hey, you bastards.'),
    ('Heyyou don''t thinksure, that''s Jon Voight''s pencil!'),
    ('Hey, you got any extra furniture down there? I need some more stuff to fill that extra bedroom with the walk-in closet.'),
    ...
    ('Hey, you know, let''s call Susan, we''ll go have coffee.'),
    ...
    ('Hi, Allison? Oh, I guess you''re not at home... I probably should ''ave tried you at the office. Anyway, good to hear from ya, really looking forward to the ball... Ha ha!'),
    ('Hi Allison, that''s a nice dress.'),
    ('Hi Amy, I''m George.'),
    ('Hi, are you OK? no, no,... huh,  She hung up.'),
    ('Hi Beth  Um anyway Jerry told me that uh... it might have been my comment in the Coffee Shop that broke you up.'),
    ('Hi, Carol.'),
    ...
    ('Ho ho!'),
    ('Ho ho. Funny. Isn''t he funny? Funny guy. Ha ha ha.'),
    ...
    ('Hotel.'),
    ('Hot? What is this?'),
    ('Housewarming gift. All right, we''re taking it up a notch!'),
    ('How about Bozo?'),
    ('How about Chinese?'),
    ...
    ('How am I gonna get out of this? Think Costanza, think!'),
    ...
    ('How''s that Tony?'),
    ('How''s the trip?'),
    ('How''s this for criticism? Umyou stink. How do like that criticism? You know what''s funny to me? That diploma up on the wall. That is my idea of ''com-med-dee''! You sitting here, telling people what to do.'),
    ('How was Eric Roberts as the husband?'),
    ('How was the show?'),
    ('How would I know?'),
    ('How would you find out something like thatwait a minute, what am I thinking? I''ve got the entire Yankee organization at my disposal.'),
    ...
    ('Hu, ha.'),
    ('Huh? All right, fine.'),
    ('Huh Cape  Why a cape? Hmm!'),
    ('Huh. C''mon, let''s go, go. We got a lot of work to do today.'),
    ('Huh. Excuse me  Hum Do you speak chinese?'),
    ('Huh haha! You''re meat, Reilly! You just screwed yourself! Ha ha!'),
    ...
    ('Huh-Hi. Uhm, is Neil here?'),
    ('Huh-ho! Have you ever seen anything like this?'),
    ...
    ('Huh, strawberries, anyone? Ah, that''s good. Ooh, juicy this time of year.'),
    ('hu hu.'),
    ('Hu-hu, like I don''t know that? My Cousin Vinnie, I love that! I, George Costanza, could be on a date with an Oscar winner! An Oscar winner, Jerry! You know what that''s like? It''s like if fifty years ago, someone fixed me up with Katherine Hepburn? Same thing!'),
    ...
    ('Huh. You must think I''m pretty stupid. That was no 5th Avenue bar. I can see the crumb right there in the corner of your lip! Now, that-that-that is a cookie - and we all know that Twix is the only candy bar with the cookie crunch.'),
    ...
    ('I always look annoyed. Yeah, when you look annoyed all the time, people think that you''re busy. Think about it .'),
    ('I am.'),
    ('I am?'),
    ...
    ('I am. The folks are twelve hundred miles away. I''m basking in the buffer zone. ''Nother piece of pie here!'),
    ('I am? What a strange coincidence...'),
    ('I asked if I could borrow a sweater.'),
    ('I banged it on the desk in the doctor''s office. An  aaaa'),
    ...
    ('I can read lips. You said let''s sleep together.'),
    ('I can see that.'),
    ('I can''t'),
    ('I can''t.'),
    ...
    ('I can''t have a cup of coffee with a person?! I''m not allowed to have coffee?!'),
    ...
    ('I''d like to apologize. I want to tell him I... I... didn''t mean to get him in trouble.'),
    ...
    ('I don''t care.'),
    ('I don''t care. Look, Lloyd doesn''t know what he''s up against. This is nothing to me. My whole life is a lie.'),
    ('I don''t chew gum.'),
    ...
    ('I don''t know.'),
    ('I don''t know, 120, 130Then they sent some guys to sandblast for 6 hours. Tomorrow they are putting in asbestos.'),
    ...
    ('I don''t know, honey. What do you want to get? I want you to get anything you want''cause I love you so much. I want you to be happy. Okay, sweetie?'),
    ...
    ('I don''t know where you''re getting this from. I.you''re serious aren''t you? Oh,  you see? You see, you just don''t know my sense of humor. Dan, don''t I joke around all the time?'),
    ...
    ('I don''t think there''s ever been an appointment in my life where I wanted the other guy to show up. Wait a second, is that him?'),
    ...
    ('I dunno, I''m in a limo. Hello ma? It''s me. Guess where I am. In the back of a limo. No, nobody died. It''s a long story, I can''t tell you now. Because I can''t. I said I can''t. If I could, I would. Would you stop it? Alright, look, I''m getting off. No, I''m not telling you! How''s this? I''m *never* telling you! I don''t care! No! Fine! Never!!'),
    ...
    ('I feel alive, Jerry.'),
    ('I feel fat.'),
    ('I feel like a family. In fact, yesterday was Grace''s birthday. She''s such a sweet woman so, we had a little party, with cake and champagne. I made a toast.'),
    ...
    ('I feel terrible, I can''t be responsible for breaking up a marriage. Oh no'),
    ...
    ('I find it disorienting. Who buys an umbrella anyway? Y..you get ''em for free in the coffee shop in the metal cans.'),
    ...
    ('If she want''s to continue to have a fibre of her being she''ll be very careful'),
    ('If that helps you...'),
    ...
    ('if you hadn''t come, this whole thing wouldn''t have happen'),
    ...
    ('If you''re having second thoughts, if you didn''t want it, don''t worry about it because uh, you know, I, II could take it, you know.'),
    ...
    ('I gotta go.'),
    ('I gotta go back to the library and talk to him. I gotta find out if I''m the guy who ruined his life.'),
    ...
    ('I guess everyone here enjoys giving the old screwgie, huh?! You''re all doin'' a hell of a job! Ho, ho. What I would do with you...'),
    ('I guess I should be, but I''m not.'),
    ('I guess it''s not important.'),
    ('I guess it''s on my resume.'),
    ('I guess I''ve been hanging on to them for so long cuz i couldn''t accept the fact that Dad was really gone forever'),
    ...
    ('I haven''t? I''m okay? I''m okay? Oh, thank you, thank you, Doctor! I don''t know how to thank you.'),
    ...
    ('I insist. I''ll fix us a drink. I got it.'),
    ('I, I really should go home. Ya... actually I''m planning on spending the day with my father tomorrow  we''re uh we''re going to a father-son picnic, just the two of us.'),
    ...
    ('II wouldn''t know'),
    ('I write a letter and then I...I go to China. I disappear in a sea of people for like six months, a year you know just while things simmer down. Ehm... EhmDear Susan. I''m sorry. I made a terrible mistake. I''m really , really sorry.'),
    ...
    ('I knew it!! I predicted it! Saw both of them today! What a disaster! I''m runnin'' all over Queens. First I saw my mother. We had lunch together. Never had LUNCH with my mother before--it''s like a date! Then we drive down to Kew Gardens! Tons of traffic! I see my father. We played ''Clue''! All day with this!'),
    ...
    ('I know!'),
    ('I know.'),
    ('I know about the vein! I can''t believe this guy...'),
    ...
    ('I know, I knowdon''t skimp. Go go go go'),
    ...
    ('I know what I''m doin''. In fact Mr. Wilhelm gave me one of those little stress dolls. All right. Back to work.'),
    ...
    ('I know who it was too. It was the guy who interviewed me. He was very threatened by me. Why else wouldn''t he hire me? I could sell latex like that .'),
    ('I know you did.'),
    ...
    ('I''ll fake an illness. My back! My back! I can''t believe, my back.'),
    ('I''ll fight ya! Not the face! Not the face!'),
    ...
    ('I''ll leave when the guy comes in. I gotta tell you, I am loving this yada yada thing. You know, I can cross over my whole life story.'),
    ...
    ('I look just like him. I. Me. This! This is what her boyfriend looks like. How is that possible?'),
    ...
    ('Imagine if I had to see them both on the same day? Haha! It''s like runnin'' a double marathon!'),
    ...
    ('I''m fine.'),
    ('I''m fine with it! Fi-hi-hi-hine I say!'),
    ('I''m following him.'),
    ...
    ('I''m goin'' in!'),
    ('I''m gonna count to three. If you don''t give up the chair, the wig is coming off.'),
    ('I''m gonna do it.'),
    ('I''m gonna get a Chow Fung.'),
    ('I''m gonna get some more of these kosher cocktail franks...'),
    ('I''m gonna go meet Danielle. There''s a new Neil in town! Hahaha!'),
    ...
    ('I''m just gonnawash. (George walks to the bathroom; screaming) WHY DID I PUT UP TWO? WHY DID I PUT UP TWO?'),
    ...
    ('I''m not going with him. I don''t even know the guy. Look, they did this for me before.'),
    ...
    ('I''m on a winning ball club, Jerry. They probably wanna pick my brains.'),
    ('I''m on no sleep, bro.'),
    ...
    ('I''m sorry Karen. I know I care for you, but I just can''t stand when someone doesn''t like me.'),
    ('I''m sorry sir.'),
    ('I''m sorry the card says MOOPS.'),
    ('I''m sorry, uh, it''s not like I''m gonna see something I''ve never seen before.'),
    ('I''m sorry, umm he-here''s your money back  I-I-I''ll have the clothes.'),
    ('I''m starving'),
    ...
    ('I''m too nice.'),
    ('I''m trying, dammit.'),
    ('I''m trying to buy some of the clothes back. Hey you wanna come over for dinner tonight? My mother made all this extra Paella.'),
    ('I''m trying to get out of this Big Brother program. So when you get to Paris  all you have to do is drop ''em in any mailbox.'),
    ...
    ('I''m working on my Jack Nicholson, You can''t handle the truth!'),
    ...
    ('I probably didn''t hear it on the way over because of the street noise. This is no good! I got to meet these guys from MacKenzie for lunch in half an hour!'),
    ...
    ('I really should get going. Y''know, I...I wanna be home in case Neil calls.'),
    ...
    ('I said, I said: ''Get outta here! No story? Is that what I said?'),
    ...
    ('I see.'),
    ('I see here that you play the harp... tell me, why do you have to tilt it? Can''t you just build it on an angle? It''d save you a lot of trouble.'),
    ...
    ('Is it, uh, doable?'),
    ('Is it with a ''y''?'),
    ('I slipped on the invitationshow''s the towels?'),
    ...
    ('Is that important, really? What is this, a police investigation? The woman''s been through enough. She has to relive the experience now?!'),
    ('Is that it?'),
    ('Is that right?'),
    ...
    ('I suppose I could.'),
    ('I suppose I could just pull this out and walk around like this and you wouldn''t care?'),
    ...
    ('I tell you, Jerry, I''m feeling something. Something I haven''t felt in a long time.'),
    ...
    ('I think so.'),
    ('I think somethin'' bit me. I just need another nickel.'),
    ('I think something''s happening here.'),
    ('I think that ginger ale at the coffee shop is just Coke and Sprite mixed together. How can I prove it? Ah! Can''t, dammit. (knock at door. George goes to open it)'),
    ('I think that''s mine.'),
    ...
    ('I think you''ve done a lot more than talk! You betrayed me!'),
    ...
    ('I tried! I almost threw it down the incinerator, but I couldn''t do it. The guilt was too overwhelming. Susan''s so attached to this thing.'),
    ...
    ('It''s a ''76 Chevy Impala. They stole it right in front of the hospital. I saw the guy drive off in it. Well he''s about five feet tall, hairless, pink complexion... looks like a pig. Yeah, alright alright, thank you, thank you. So any word from the ''pig-man''?'),
    ...
    ('It''s a funeral procession . And I got news for you. I show up with Ring Dings and Pepsi, I become the biggest hit of the party. People be coming up to me, ''just between you and me I''m really excited about the Ring Dings and the Pepsi. What are we, Europeans with the Beaujolais and Chardonnay'),
    ...
    ('It''s a pot pourri. May I, uh, may I show you the master bedroom?'),
    ...
    ('It''s funny! and it wouldn''t kill you to not be so funny either.'),
    ('It''s, funny runnin'' into you here.'),
    ('It''s George'),
    ('It''s George.'),
    ('It''s GEORGE:.'),
    ('. It''s George Costanza. . are there any messages for me? Why does Mr. Steinbrenner want to see me in his office?  Communist? I''m not a Communist  . All right, all right. All right, I''ll be there. -  My secretary Ada, told Mr Steinbrenner I''m a Communist Now he wants to see me in his office.'),
    ('It''s good. Believe me.'),
    ('It''s good, right?'),
    ('It''sgotta hurt! Hurt! BecauseAaarrrrrgh!'),
    ...
    ('It''s right in the explosion scene. So if you could justleave me a little window. You know, my, uh, my aunt had a thing removed with a laser. All right, I don''t want to interrupt your meal, so'),
    ...
    ('It''s, uh, it''s not a little chicken. Little chicken. It''s a gamebird.'),
    ('It''s uh, it''s only a few blocks.'),
    ('It''s uh, not bad, it''s comin'' along. Why? Did you need something.'),
    ...
    ('It was a good jig.'),
    ('It was all a terrible misunderstanding, sir. Just five minutes. Just five minutes of your time. Thank you! Thank you, Mister Dalrimple.'),
    ('It was an inferno in there! An inferno!'),
    ('It was fantastic, Jerry. We wound up talking all night.'),
    ('It was kinda fun. You know, maybe his name really is J-O-H-N, but he changed it to J-O-N for show business. Well, you know, J-O-N is a lot zippier.'),
    ...
    ('It was on CNN  This Chinese doctor Zeng Zau. has discovered a cure for baldness.'),
    ...
    ('I, uhfigure it''s something.'),
    ('I uh got the first name.'),
    ('I, uh, just think it''s a little unusual. Two people to sit on one sideand leave the other side empty.'),
    ...
    ('I''ve been to a few of em. If you uh start to get woozy later, which is quite common, stay close to me. I''ll get you through it.'),
    ...
    ('I was jumping over a puddle, and for some reason I went like this. And they called me a Mary. So I chased them, and I tripped and I fell.'),
    ...
    ('I was squinting! Remember that drive from Wortsborough? I was spotting those raccoons.'),
    ...
    ('Iwas trying to lead the way. We needed a leader! Someone to lead the way to safety.'),
    ('I was trying to loosen ''em up a little bit.'),
    ('I was trying to stick the landing. was right around here.'),
    ('I was wrong, you were right.'),
    ('I watched ''Beaches'' on cable last night. Give me a break.'),
    ...
    ('I wish that was all needed. Life can be so confusing. I...I''m searching for answers, anywhere.'),
    ('I wonder how Susan''s father''s going to react to this. Alright, what- what''s the worst he could do? So you burn a cabin down...'),
    ('I wonder if, ah, Susan   No. I better just go. heh. All right! See ya.'),
    ...
    ('I would like to dip my bald head in oil and rub it all over your body. You don''t understand! It''s a miracle! You don''t understand because you don''t speak English!'),
    ...
    ('Jerry, I''ve found a way to beat Lloyd Braun! I buy the computers myself, I store ''em in your apartment. Then, after I win the contest, I bring ''em all back and get my money back. Ha ha! It''s brilliant. What? What''s wrong with your leg?'),
    ('Jerry, Jerry'),
    ('Jerry, Jerry?'),
    ('Jerry. Jerry.'),
    ('Jerry? Jerry! I''m busting! I''m busting!'),
    ('Jerry! Jerry! Je Jerry Jerry . The most unbelievable thing has just happened, it''s too Unbelievable! I''m sitting in the coffee shop, i''m talking to Susan, were talking about shoe laces  The exact same thing that I said to him, just to get back at me just to get back at me...and then, and then she says she wants to be alone for awhile...Alone Jerry! I think that she thinks that she could do better  Do you appreciate this? Do you see the irony of this? Do you see what is going on here? What''s the matter?'),
    ('Jerry! Jerry, muh--muh--my hair-dryer ruined the picture! An'' I need another one or I can''t get back into the forbidden city!'),
    ...
    ('Jerry, what''s happening? Come on, pick up the phone.'),
    ...
    ('Jerry? Yes, I suppose he is white. You know, I never really thought about it. I don''t see people in terms of color. You know, there''s someone I''d like you to meet. Hand on  Is Mr. Morgan in?'),
    ('Jerry, you came for the big moment.'),
    ('Jerry you gotta bring me some clothes down here. I lost my job with the Yankees. I''m standing in the men''s room on 43rd street in my underpants.'),
    ...
    ('Jimmy, right.'),
    ('JODI!'),
    ('Jody let''s do this agian real soon'),
    ('Jody''s nice.'),
    ('Joe'),
    ('Joecould you'),
    ('Joe DiMaggio.'),
    ...
    ('Just nice?'),
    ('Just one? I''m living like twenty. What''s yours?'),
    ('Just put it on! All right now, remember she had her nails done today so remark how you like the color. And if you need me you beep me, all right. Here you go, hey, hey, hey, hey Go get''em you''re a tiger!'),
    ...
    ('Keith, Keith, up here. Can you do me a favor? I need you to go to the unemployment office with me. I, I''m Jerry''s friend  the guy from the locker room,  I''m the chucker. It''ll take five minutes. Wait. Wait.'),
    ...
    ('Kramer, do you know what those guys are gonna do to me?!'),
    ...
    ('Kramer!! Kramer no!!'),
    ('Kramer, Kramer''s not hereI knew it. I knew it! I knew this would happen. Kramer! Kramer!'),
    ...
    ('Kramer, what are you talking aboutJanet doesn''t look anything like Jerry'),
    ...
    ('Lemme see. I can''t believe you got these for free. Row F?!'),
    ('Lemme see this.'),
    ('Lemme tell you something, that Jerry Lewis? You wonder how some of these people get to the top? It''s ideas like this! Brilliant! Hah-hah! Look at this - what the hell happened? The whole side is damaged hereand the lock is broken.'),
    ...
    ('Let me tell you something about that tag. It''s no 31, and uhlet''s just leave it at that.'),
    ('Let me tell you something. No one walks into a beauty parlor and says ''Give me the Larry Fine.'),
    ('Let me tell you who did, uh, buy itum we pitched this story to Russell Dalrymple, the president of NBC, and he ate it up with a spoon.'),
    ('Let''s do it.'),
    ...
    ('Like you do.'),
    ('Lingerie?'),
    ('Listen, Buck, I uhobviously I don''t need to talk to you about the importance of player morale, but uhI''ve been talking to some of the guys, and some of them - I don''t want to mention any names - but some of themthey''re not too happy with the polyester uniforms.'),
    ...
    ('Listen, I...I...I don''t mean to seem forward'),
    ...
    ('Listen to the comeback. ''Oh yeah? Well the jerk store called. They''re running outta you.'),
    ...
    ('Listen, you''re lucking I''m not asking for a whole refund. You gave me ladies'' frames!'),
    ('Little baked beans'),
    ('Little Rock, Arkensas.'),
    ('Live?'),
    ('Lloyd Braun? What d''you have to meet him for?'),
    ('Lobster.'),
    ('Look, if you want to taste mine, you don''t have to offer me some of yours.'),
    ('Long as they don''t throw ''em on the field. Huhu. Help yourself to some shrimp, I brought enough for everybody.'),
    ('Loni Anderson?!'),
    ...
    ('Look at this, I only have one picture left How ''bout a shot of me and Mr. Morgan?'),
    ('Look at this sparkle. Mrs. Enright! Mrs. Enright! Mrs. Enright!'),
    ('Look at this. There''s no spaces here. Excuse me, are you gettin'' out?'),
    ('Look at where we are! He''s not stopping! He just keeps going and going and going! We''re not in the first row?'),
    ('Look, Deena, I know you think I''m crazy, but I''m not. This is just a series of bad coincidences.'),
    ('Lookhumm..I''m on with Beijing with the hair restauration clinic. Could you talk to them for me and tell them I''d like to place an order.'),
    ...
    ('Look, I gotta tell yaI been thinkin'' about it, I just don''t feel right about letting you into Elaine''s apartment.'),
    ...
    ('Look I, I uh, I had nothing to do with this. It wasn''t my decision. It was Jerry! Jerry told me no. I''m the creative guy. He handles the business end.'),
    ...
    ('Look. It''s a skill, just like juggling. She probably enjoys showing it off.'),
    ('Look it''s no secret what''s going on between us. She doesn''t like me. Now Jerry if you don''t mind.'),
    ('looks like my mother.'),
    ('Looks like veal.'),
    ('Looks pretty good.'),
    ('Look, we are gonna settle this right now! I demand reparations! I should get to sleep with Elaine. That''s the only way to punish you!'),
    ...
    ('Loves bald? Wow. Who uh, who is she?'),
    ('Love to!'),
    ('Love to.'),
    ...
    ('Mario''s Pizza.'),
    ('Marisa Tomei!'),
    ('Marisa Tomei! I, just spoke to Marisa Tomei! And I wasn''t even that nervous.'),
    ('Marisa Tomei''s sitting home, Elaine! Wh...why didn''t you tell me that Katy was friends with Marisa Tomei?!'),
    ('Mark, is this true?'),
    ('Marla.'),
    ('Married , What!'),
    ('Marsala?'),
    ...
    (': ''Master of the house/Keeper of the inn'' (Jerry re-enters the living room and modestly models his new jacket for George. George is impressed.) This is huge! When did this happen?'),
    ('Master of the House/Quick to catch your eye/Never wants a passerby to pass him by'),
    ('Matches? Long matches.'),
    ('Maura, I, uh- I want you to know I-I''ve given this a lot of thought. I''m sorry, but we, uh, we have to break up.'),
    ('Maura. Oh, my God! What are you doing here?!'),
    ('Ma, will you stop? It''s just a statue! How is it my fault?! It was stolen. I didn''t even touch it this time Okay, fine I don''t see why this should affect to potatoes! Okay Goodbye. She doesn''t react to disappointment very well. Unlike me.'),
    ('Maybe.'),
    ('Maybe a black.'),
    ('Maybe!... And I''m moving back in there!'),
    ('Maybe for her new performance piece she''ll give birth on stage.'),
    ('Maybe he didn''t show up.'),
    ('Maybe he doesn''t. Maybe he and I are exactly the same, except for one minor, yet crucial, detail. You never know.'),
    ...
    ('Maybe she can get me another picture of man-hands. Elaine!'),
    ...
    ('Me? Oh yeah.'),
    ('Merry Christmas, Merry Christmas! Oh, Sandy! Here is a little something for you...'),
    ...
    ('Mister Dalrimple! Mister Dalrimple I have to talk to you!'),
    ('Mister Fowler, I-I have a squirrel here that is a miracle of modern science!'),
    ('Mister Seinfeld? What about Mister Costanza? I''m not here?'),
    ('Mm-hmm. Mm-hmm. All right. I don''t think we''re gonna have any problem with that. Good talking to you Tom. Really.'),
    ('Mmm.'),
    ('Mmm-hmm. You reneged.'),
    ('Mmm-mm.'),
    ('Mmm no.'),
    ('Mmm, no. Boy, it really didn''t come out too well, did it?'),
    ('Mm? Oh, hi. Oh, yeah, yeah, yeah. We met uh, skiing that time. You''re uh, married to the eye guy.'),
    ('Moisturizer?'),
    ...
    ('Mr. Wilhelm!'),
    ('Mr.Wilhelm'),
    ('Mr Wilhelm, listen. You''ve been abducted! Please, Mr Wilhelm, you gotta listen to me!'),
    ...
    ('My code?'),
    ('My cousin worked for Bouchard''s. They used to use the bouilla-base for a toilet.'),
    ('My credit card?'),
    ...
    ('My god!!!'),
    ('My hand is out.'),
    ('My heart! My heart! Where you going? Are you crazy?!'),
    ('My in-laws. Oh, my.'),
    ('My Job...arghhh'),
    ...
    ('Nevertheless... I was wondering if you and your .friends are doing business here at the Jiffy Park. You know ...hum What do you people call it? Turning tricks? Anyway II.found a condom in my car.and I''m not saying it''s yours but. I want to know if I should just change parking lots.'),
    ('Never thought I''d fail at failing.'),
    ('Newman!!'),
    ('Newspaper.'),
    ('Newww tuxedo. For the Pinstripe Ball. Steinbrenner is throwing a huge party at Tavern on the Green, heh!'),
    ...
    ('N.I. Not interested.'),
    ('Nnnnnnngaaa!'),
    ('N...no, no. You can''t leave me. Marry me! I''ll burn myself. I''ll burn my parents!'),
    ('*No*'),
    ('No'),
    ('No!'),
    ('No.'),
    ...
    ('No, Can''t beFor instance I remember when we first met, we had a great conversation.'),
    ('No, can''t say as I did.'),
    ('No catchin''.'),
    ('No! Check! Please.'),
    ('No Chinese leftovers. George is gettin'' suspicious.'),
    ...
    ('No, he, he didn''t actually tell me that, uh, we were talking about that commercial '' in fact I think I brought it up because I like that commercial. No, he, he would never tell me anything. He never discusses anything. He''s, he''s like a clam. You''re not gonna mention this, to him'),
    ('No, he isn''t.'),
    ...
    ('No he''s not right. Al Netchie is not right! Alright I''m canceling the father-son picnic. I don''t know what he''s gonna do with all that potato salad.'),
    ...
    ('No, I can''t. She knows I go there. It''s not secure. Hey, I got another call comin'' in. I gotta let the machine get it. Bye.'),
    ...
    ('No. I''ll dip the way I want to dip.'),
    ...
    ('No, I was just wondering. The information could be relevant.'),
    ('No, I won''t.'),
    ...
    ('No, Lindsay, it was not IN the garbage. It was above the garbage. Hovering. Like an angel. Of course I know your aunt bit it. I kissed her goodbye. Listen, can I tell you something else? In my family, we used to eat out of the garbage all the time. It was no big thing. That''s right. Oh, okay. Buh-bye. I''m back in, she gave me a second chance.'),
    ...
    ('No, ma, I''m not gonna see a psychiatrist. N- I don''t care if you do pay for it! No! Discussion over. Yeah, alright, I''ll see you later. Yes, of course I''m gonna come by. Alright. (Hangs up, slamming it down on the coffee table. He sits down next to Jerry) My mother wants me to see a psychiatrist now. Why?! Because she caught me? You know, if everyone who did that had to go see a psychiatrist...'),
    ...
    ('No No I''m working on a systemWho was that?'),
    ...
    ('No no no, I got it.'),
    ('Nonono, I hate to tell you this. You''re not gonna see this woman.'),
    ...
    ('No, no, no. Just lately, I''ve been thinking a lot clearer. Like this afternoon,  I really enjoyed watching a documentary with Louise.'),
    ...
    ('No, no, no, no. I can walk it off. It''s a hundred and twenty degrees in here... I''ll sweat it out.'),
    ...
    ('No, no. No, no, no. We''re staying on me. We haven''t solved anything yet.'),
    ('No no, no no no. You''re not goin'' in there.'),
    ('No. No, no, no. The cushion was turned over.'),
    ...
    ('No, no, not really. Ever since Susan passed on, I have good days and bad. Some days, I''m haunted by one word - why. Why Susan? Why wasn''t it me licking those invitations? Why am I still here? Well, I gotta run.'),
    ...
    ('No, not nervous. I''m good, very good. I can''t do this! Can''t do this!'),
    ...
    ('No, no, you can''t do that, they''re round, it makes an ''eight'' and, yeah, well alright.'),
    ...
    ('Not a peep. They just cleaned the carpets and left. Call themselves a cult!'),
    ...
    ('Not even an apple.'),
    ('Not even close, huh?'),
    ('Not everybody knows what the crop circles are. Do you know what the crop circles are?'),
    ...
    ('No, that''s not enough BTUs for my living roomThat was a complete waste of time.'),
    ...
    ('Nothing. I don''t knowjust a little dirt.'),
    ...
    ('Nothinglittle problem.'),
    ('Nothing really, you knowjust eh, stroll around the cell blocks, maybe eh, take in a shower fight. Hey eh, you know you got a bounced check hanging up in the little market over on Columbus?'),
    ('Nothing. Uh, I don''t know. I gotta go.'),
    ('Nothing, why? You think something''s wrong? Am I different?'),
    ('No. This is not cotton. Here, lemme see. (Tries to look at the tag on the uniform. Tartabull gets creeped out and resists.) Will you stop it? Oh. Of course. Polyester!'),
    ('Not in the last fifteen minutes.'),
    ('Not me.'),
    ('Not me! Him! His fault! He betrayed me!'),
    ('Not necessarily.'),
    ('Not necessarily. Mustard lends itself to the squeeze.'),
    ('Not necessarily. Why don''t you take back the couch you gave me?'),
    ('Not now.'),
    ('Not now Florice.'),
    ('Not possible.'),
    ('Not quite.'),
    ...
    ('No t Why should that make any difference to you?'),
    ...
    ('No, you won''t.'),
    ('No you wouldn''t. Nobody would. It''s just that they were missing, and well I''m just inquiring.'),
    ('Nucleosis.'),
    ('Obviously.'),
    ('Of course.'),
    ...
    ('Of course I do.'),
    ('Of course I''m all right. I''m here with my girl, Nina. And what better way to pass the time than gabbing with my best friend -- with whom there are no secrets. Like this. Since the fourth grade.'),
    ...
    ('Oh Articulate. Me? I''ve never articulated anything, i''m completely incoherent.'),
    ...
    ('Oh, by the way, order anything you want, it''s all on me. Just do me a tiny favor: pretend we''re old friends. Oh my God! Mr. Morgan! What a coincidence, it''s Mr. Morgan. Mr. Morgan, I want you to meet a dear old friend of mine, Carl.'),
    ('Oh, can you be any more dramatic?'),
    ('Oh clothing, something, I dunno. So, uh, what are you doing today?'),
    ('Oh, c''mon, Jerry. I can''t believe this.'),
    ('Oh, come on.'),
    ('Oh, come on! Be sensible.'),
    ('Oh, come on, it''s five minutes.'),
    ('Oh come on? No come on. She took off her hat and there she was  hello. It was like I was looking at myself in the mirror.'),
    ...
    ('Oh - comfort, schmomfort. Listen, Father, can I ask you a question? In a terrible time like thiswho would I get the death certificate from?'),
    ('Oh. Course not.'),
    ('Oh, deserve! I don''t know if I deserveI mean'),
    ...
    ('Oh, he''ll be here. By the way, Elaine,  thank you for laying out for the Arabian mocha java.'),
    ('Oh, hello, Hanke, others.'),
    ('Oh, hello, it''s you! Listen lady, I got six minutes left on that meter, and I''m not budging til you admit you stole my twenty dollars. Huh-hu-hur, you''re not so tough when you''re not on your horse, are you Ruthie?'),
    ('Oh, hello Professor.'),
    ('Oh, here we go'),
    ('Oh! Here you are. Ha haYou, uh, you want to--'),
    ...
    ('Oh hey, if you happen to see the most beautiful girl who walked out on me. Tell her I''m sorry. Tell her I need my baby  oh won''t you tell her  I love her. Oh hey,'),
    ...
    ('Oh, Hi, I''m George.'),
    ('Ohh, I wanted to see that. Thanks. Thanks a lot.'),
    ...
    ('Oh, I got it.'),
    ('Oh I got it. That I''m supposed to remember. Where the car is, that''s insignificant.'),
    ...
    ('Oh I''m a chucker.'),
    ('Oh, I''m crazy!'),
    ('Oh, I''m goin'' baby. I''m goin.''  It''s Jerry''s fault. He took out all my good lines. He''s such a control freak!'),
    ('Oh I''m going baby! I''m going!'),
    ('Oh, I''m gonna give you a Royal bearing. Wait a minute, wait a minute. Lemme get a pack of gum here.'),
    ...
    ('Oh, I think so, and I can prove it. You see, I was doodling on the bill and uh, so if you have a twenty in there with big lips on it well,  that''s mine. Would you mind opening up the register?'),
    ...
    ('Oh, it''s a lovely song. ''How do you solve a problem like Maria?'),
    ...
    ('Oh. It''s just horse manure  Horse manure''s not that bad. I don''t even mind the word ''manure.'' You know, it''s, it''s ''nure,'' which is good. and a ''ma'' in front of it. MA-NURE. I mean when you consider the other choices, ''manure'' is actually pretty refreshing.'),
    ('Oh, it''s locked?'),
    ...
    ('Oh, I wanted to talk to you--I''m sorry, I--didn''t know you  had company. Hiya, I''m George.'),
    ...
    ('Oh, look at this. There''s no place to park around here. I don''t even know why they sell cars in Manhattan.'),
    ...
    ('Oh man! Look at this! I sat in gum. Oh, by the way, you owe me seven fifty.'),
    ('Oh, me, me, me, me, me!'),
    ('Oh! Modelling! What''s that like? Fun? Ha ha. Stupid! Stupid! Stupid!'),
    ('Oh mother of God.'),
    ('Oh my god.'),
    ('Oh! my god'),
    ('Oh, my god!'),
    ...
    ('Oh my God, it''s 7:01. What have I done? My whole plan is depending on Kramer? Have I learned nothing? How could I make such a stupid mistake? He''ll never show up!'),
    ...
    ('Oh my god, there she is. That''s the face, just like the picture.'),
    ('Oh my God! What is that?!'),
    ('Oh my God! You know what I just realized?! If they get divorced an'' live in two separate places? That''s twice as many visits!'),
    ('Oh my GodYou''re in jail? That is so cool!'),
    ('Oh! my God!!You?...You?That was you?.'),
    ('Oh my gosh, I just had a great idea. She could come to the party tomorrow and read Gwen''s lips for me.'),
    ('Oh... nice.'),
    ('Oh, n-no comparison.'),
    ('Oh, no.'),
    ('Oh no, I am down!'),
    ...
    ('Oh, no, no--'),
    ('Oh, no, nocondoms are for single men. The day that we got engaged, I said goodbye to the condom forever.'),
    ...
    ('Oh, no, no, noyou sit right hereI will get you a nice snack.'),
    ('Oh, no. No stories.'),
    ('Oh, nono, that''s very bad for the kidneys.'),
    ('Oh, no, nothing.'),
    ('Oh, no, not just me, the whole organization. Especially Mr. Morgan.'),
    ('Oh, no, no. Twix is the only candy with the cookie crunch.'),
    ('Oh, no. No. We''re good. Let''s get goin''. Alright. Watch it, funny man.'),
    ...
    ('Oh! Nuts! Excellent! You know what I love? How there''s two nuts named after people. Hazeland filbert.'),
    ('Oh, of course. Of course.'),
    ('Oh of course you can use it, sure. Ok, bye.'),
    ('Oh, oh!'),
    ('Oh. Oh!'),
    ('Oh-ohf  yeah, I''m a writer.'),
    ('Oh Oh, here, lemme uh'),
    ...
    ('Oh. Oh. Yeah, sure. Here. Uh, sit down. Uh, uh, cheese, there?'),
    ('Oh, oh, your papers'),
    ('Oh, okay.'),
    ('Oh! Okay.'),
    ...
    ('Oh, o.k., yeah. Where am I gonna park here?'),
    ('Ohooo what are we going to do? I''m shaking! I''m shaking!'),
    ('Oh please.'),
    ('Oh, please. Can you change this into bills?'),
    ('Oh, please don''t.'),
    ...
    ('Oh, real good. Any word from NBC?'),
    ('Oh. Really.'),
    ('Oh really. You tell her you shaved it?'),
    ('Oh, right. Oh no, man.'),
    ('Oh, right! Right! Hey, hey... I love the floors in here. It''s like a gymnasium in here! Try and guard me! (Dribbles an imaginary ball'),
    ...
    ('Oh, Rita. Hey, Mr. Shermack, how''re you doing, good to see you. Jay, always a pleasure. Sweetie. Yeah, yeah, that butler idea, that''s beautiful. Isn''t that killer? I thought I was getting the butler.'),
    ('Oh, Safire. Uh ha'),
    ...
    ('Oh, sorry.'),
    ('Oh. Sorry.'),
    ('Oh!, so what. I''d rather she hate me and thought I was good looking.At least I can get somebody else. What is this? Why am I itching?'),
    ...
    ('Oh, sure. Of course. Um, uh, could you hold these? For just a second, just a second. Here you go, now don''t worry about a thing. It''s gonna be fine. Here we go. Look at this shine.'),
    ('Oh, sure. Sure, anything. Can you believe it? There''s nothing wrong with me.'),
    ('Oh sure, sure. You wanna be alone, sure. I understand that, you wanna a little time to think uh thing...ponder things...you know...ruminant... you go ahead, lotta stuff on your mind...you think things out...Think, mull, mull, do a lot of mulling.'),
    ('Oh, Tara!'),
    ...
    ('oh Tony don''t'),
    ('Oh, uh'),
    ('Ohuh, because if it had anything at all to do with what you perceived as me leering at your daughter, I really have to take issue with that. I did not leer. Did I leer?'),
    ('Oh uh hi Hi, David'),
    ('Oh, uhit''s George.'),
    ('Oh, uh, just a friend of mine.'),
    ('Oh, uh, the cigars... I''m, uh, suckin'' ''em down. I''m puffing my brains out, yeah.'),
    ('Oh, uh, ''The Falconer'' by John Cheever. It''s really excellent.'),
    ('Oh, uh, wait a minute, wait a minute. Is this about money?'),
    ('Oh uh. You ready?'),
    ...
    ('Oh, well, don''t worry about it -- he''s got plenty of money.'),
    ...
    ('Oh, well, I''m sure you can reach hershe''s a poet. What does a poet need an unlisted number for?'),
    ('Oh, well, so what? Laughter - what is that? I mean, what is the point of opening your mouth and going ''Ha, ha!''? What is that? ''Ha, ha!''?'),
    ('Oh well, that''s, uh, that''s just because we''re, uh, standing on opposite sides.'),
    ...
    ('Oh yeah, Reilly? Well, the jerk store called. They''re running outta you'),
    ('Oh, yeah, right. I wish I had something on my mind. So how about that Kramer, huh?'),
    ('Oh yeah, right. When''s he coming back?'),
    ('Oh yeah... Sally called Susan - said you guys really hit it off.'),
    ...
    ('Oh yeah. These are fantastic, fantastic. You know, I''d love to get a jump on the next batch, where do you come out? She''s been ignoring this section all night. Quesadilla?'),
    ...
    ('Oh, yeah. Yeah. I used to come here all the time with my fiance, back when it was a meat-packing plant. Ha. Here''s her picture.'),
    ...
    ('Oh yes, of course, and we have to be fair.'),
    ('Oh, yes of course, come in.'),
    ('Oh, yes, yes, yes. Very, very hard.'),
    ('Oh, you are such a wuss.'),
    ('Oh you can stuff your sorries in a sack, Mister!'),
    ('Oh, you do?'),
    ('Oh, you have a policy! The delicate genius has a policy! George heads for the door.'),
    ...
    ('Okay, go ahead.'),
    ('Okay, go ahead. Call her, get married, have babies, have a great life... What do I care? I''m finished. It''s all over for me. In fact, let''s end it right now. Jerry, kill me, kill me now. I''m begging you. Let''s just get it over with. Be a pal... Just take the pillow and put it over my face.'),
    ('Okay. Good.'),
    ('Okay. Hey, you know what, maybe I shoud give it to my therapist to read. She''s smart, I trust her.'),
    ('Okay. How about this?'),
    ...
    ('Okay, look. We''ve never worked together on a lie. Now, you don''t understand how I work. I have a certain way of working. Jerry and I have worked together a few times. He knows how I work. It''s not a personal thing, y''know? We''re just trying to come up with the best possible lie. That''s what this is all about.'),
    ('Okay. Now, why do I have to see  you?'),
    ('Okay. Okay. Fine.'),
    ...
    ('Okay. OK. I''ll choose you. Whaddaya want?'),
    ...
    ('O.K., Danny, take a swing. N-No! No! No! You''re opening up your shoulder.'),
    ('Ok, everybody, uhI have an announcement to make. From now on, I will be known as-'),
    ...
    ('OK, I''m tellin'' you right now - if your kiddin'' around I''m not gonna be able to be your friend anymore. I''m serious about that. You got that.'),
    ('O.k.(is about to explain. Cut to Jerry on-stage.)'),
    ('O.k. I think I know where we can get one.'),
    ('Ok, it''s a deal!'),
    ('OK Look, the gum isn''t cutting it for me. We need to be about something elseanything...please.'),
    ...
    ('Ok, we got yourgot your strawberries, your chocolate sauce, your pastrami on rye with mustard, your honey'),
    ('Ok, what did you say?'),
    ('Olive?'),
    ...
    ('on the left--exquisite marble! High ceilings. An'' a flush, like a jet engine! Ha ha!'),
    ('Ooh!'),
    ('Ooh, a shower cap!'),
    ('Ooh ho hoo, forget it.'),
    ('Oohohospicy mustardwoohoho, you''re hot tonight!'),
    ...
    ('Out. Wow. I spend so much time trying to get their clothes off, I never thought of taking mine off. (Jerry nods; George looks at his watch) Alright, Hey come on, get out of here, Dophne gonna be here any minute.'),
    ...
    ('Oww.'),
    ('Ow! What are you doing under there? Hey, stop that! Don''t eat that! That''s not food! He''s suckin'' down Equal packets!'),
    ...
    ('Pbbbs, Bubkis!'),
    ('Peggy! His daughter Peggy. Peggy''s coming over to serve.'),
    ('Pennypacker. Varnsen.'),
    ...
    ('Percentage?'),
    ('Perhaps.'),
    ('Perhaps. I walk in, everything is organized -- messages, appointments. And I can''t tell you how proud I am of myself for going with Ade.'),
    ...
    ('Piece of cake; hu.'),
    ('Plans. Schemes. She ah, she keeps talking about getting back together with her old friends, you know - ''the gang,'' as she likes to call them , you know. Yeah, they''re eh, they''re hatching something, you can count on that.'),
    ...
    ('Please, please, they''re gonna hit me!'),
    ...
    ('Prognosis Negative!'),
    ('Psh. What''s the point of even discussing it? You''ll give me the money when you have it. I, I trust you.'),
    ('Pssh. Would the protege pick up stuff for the mentor?'),
    ('Pssh. Yeah. Right.'),
    ('Psst, You''re telling me.'),
    ('Pst. Wilkinson''s got a bite on a new one. Petramco Corp. Out of, uh Springfield. I think. They''re about to introduce some sort of a robot butcher.'),
    ('Pudding skin singles.'),
    ('Puddy''s just gonna give you the car, huh? You''ll see. First they stick you with the undercoating, rust-proofing, dealer prep. Suddenly, you''re on your back like a turtle.'),
    ...
    ('ReallyI have to sayYou were really good doing that porno thing.you''re talented.'),
    ...
    ('Really? Well, we''ll just see about that. Ta-ta, Tut-tle.'),
    ('Really? Well, what if it doesn''t stop? Oh, that I really needed to hear. That helps a lot! All right, just say something. Just start talking. Change the subject. Let''s just go, All right? I can''t believe we''re having dinner with Alton Benes.'),
    ('Really? Well, you don''t think it had anything to do with what I said, do you?'),
    ('Really? What does it mean?'),
    ('Really? What happened?'),
    ('Really? Who?'),
    ('Really? Why?'),
    ('Really? Wow, you''re quite the good son.'),
    ('Really? You know Gary, I really have to say, I''m a little bit hurt that you didn''t decide to confide in me.'),
    ...
    ('Relationship internhey, what if two of us teamed up?'),
    ...
    ('Right.'),
    ('Right above you?'),
    ('Right, alright. Oh Jerry, do you have any apples?'),
    ...
    ('Right. C''mon! I''m having an affair with Elaine?! If I was having an affair with Elaine, I wouldn''t tell you I''m going to see Elaine. I would make up some other person to tell you I was gonna go see, and then I would go see Ela...Elaine.'),
    ...
    ('Right. Nastercoff... What country is he from, again?'),
    ('Right now?'),
    ('Right out of the clear blue sky?'),
    ('Right, ready?'),
    ('Right, right.'),
    ('Right. So I call her up, I tell her it''s me, she gives me an enthusiastic ''Hi!'),
    ('Right. The other members of our party. Other members of our party? What other members of our party? I didn''t even know we were in a party. Oh, I''m telling you, the jig is up.'),
    ('Right... the sign.'),
    ...
    ('Scissor. Don''t hand them to me with the point facing out!'),
    ('Screw the Drake!'),
    ...
    ('Seven-eight-four.'),
    ('Seven forty-five.'),
    ('Severance packageThe Yankees are giving me three months full pay for doing nothing.'),
    ('Shadow!'),
    ('Shake his hand?'),
    ...
    ('She doesn''t know that. We say that you do.'),
    ('She doesn''t like. Here is your blue one, it''s her favorite.'),
    ...
    ('She''ll be fine. I gotta go to the hospital to see her tonight.'),
    ('She''ll open!'),
    ('She''ll Twirl.'),
    ...
    ('She''s got everything, right? She''s intelligent, she''s smart, she''s got a great sense of humour.'),
    ('She''s in traction.'),
    ...
    ('She stole twenty dollars from me. Yeah, I might''ve gotten it back, but Lloyd Braun interfered!'),
    ...
    ('She works for NBC.'),
    ('Shhhhh. If you want to get in, there''s very little time. Sweetheart... (Waitress approaches and tears off a check. George stops her.) No, no, no. That ought to cover it. (He hands her some money; she turns to leave; George stops her.) Just a second. Just a let me jus-peek (He looks at the check, then takes some money out of her hand. George urges Jerry and Elaine to eat.) Come on, come on, come on'),
    ('Shhh! Listen, you gotta do me a favor. Give me your wallet. I''ll give it back to you later.'),
    ('Shhh What is wrong with you? You never tell ''em you like the car. You''re not sure what you want. You don''t even know why you''re here.'),
    ('Shh! This is it!'),
    ('Shocked?'),
    ('Shoplifting.'),
    ('Shortness of breath...'),
    ...
    ('So'),
    ('So?'),
    ('So--ah, Kramer. Why''d you ask me out to dinner? An'' why Pomodoro?'),
    ...
    ('So Can I have it?'),
    ('So, Carrie, you and Susan are cousins. So your baby daughter is gonna be Susan''s second cousin, right? So what does that make me?'),
    ...
    ('So, how come nothing ever happened between you and Nina? Is there a problem with her? Is she a man?'),
    ...
    ('Some guy. Some guy? Neil! I have got to find out how he could get a girl like Danielle.'),
    ('Some more merlot?'),
    ('Someone''s have to unhook the boat before it leavesthe place!'),
    ('Some other time.'),
    ...
    ('Sorry, you don''t know what''s going on out there! Who''s he?'),
    ('Sorry. You''re sure, uh, there isn''t anything else?'),
    ...
    ('So she starts vaccuming, back and forth, back and forth, her hips swivelling, her breasts, uh'),
    ('So, she''s the loser of the group. Every group has someone that they all make fun of... Like us with Elaine.'),
    ...
    ('So you''re havin'' the sex, next day you don''t have to call. That''s pretty good. Go ahead.'),
    ...
    ('So, you send me to this therapist to help me with my emotional disorders, and she criticizes our script. What kind of a therapist is that?'),
    ...
    ('So, you wanna go home andmake up, officially?'),
    ('So, you want to come down to Mario''s Pizza with me and help me pick up the Frogger?'),
    ('So, you were saying how, umabout the script'),
    ...
    ('Students can''t clean. It''s anathema. They don''t like it.'),
    ...
    ('(Takes a few seconds to mull this one over. Shooting Jerry a confused look, he repeats it) ''The panties your mother laid out for you''? What does that mean?'),
    ('Take the suit.'),
    ...
    ('Ten minutes! Here, here,  Have some Tic-Tacs.'),
    ...
    (' That guy was amazing, he could dunk and he was my heightWhat was his name again?'),
    ('That I''m used to.'),
    ('That is an opening.'),
    ('That is really nice.'),
    ('That is so funny!'),
    ...
    ('That''s all''?! That''s everything! I don''t know what all the rest of it is for anyway!'),
    ...
    ('That''s my toaster. I got to go. Ohhhhhhhhhhhhh!'),
    ...
    ('That''s rightWe just had sexYou know Jerry I''ve been searching for someone a long time. Well the search is over.'),
    ...
    ('The guy who pitched him the show with the stories about nothing. Jerry Seinfeld. Jerry Seinfeld''s friend.'),
    ('The hell with them?'),
    ('The Human Fund.'),
    ('The Indian?'),
    ...
    ('The next morning, I woke up, and it was going like this. I can control it if I really concentrate. But otherwise,  oh.'),
    ...
    ('Then, the last person to leave is Wilhelm. He sees my car, he figures I''m burning the midnight oil. Between the two of them, they think I''m working an 18 hour day!'),
    ...
    ('The ocean called. Running outta shrimp. Outta shrimp! Oh! Yes! That''s what I shoulda said! Dammit!'),
    ...
    ('The perfect combination of Mountain Dew and mozzarellajust the right amount of grease on the joy stick'),
    ...
    ('The prop comic? Oh, hiI didn''t recognize you, whatdid you get a haircut?'),
    ...
    ('There''s a hundred different things here. What''s the difference between these two? You got propylparabin?'),
    ...
    ('There''s nothing I can even impart to you, that''s the sad thing. It''s so inborn, I can''t pass it on. Look at this guy. Are you crazy, what are you doing?! Hey! Hey, you''re stealing my space!'),
    ...
    ('These old guys, they''re up at 4 a.m., by two thirty they''re wiped. How did we get back onto you?!'),
    ...
    ('The tag, huh?'),
    ('The thing isI''m supposed to be T-bone.'),
    ...
    ('The uh, the shoe laces that you bought me, they uh, they worked out well.'),
    ('The uniforms! Did you see how they played? Listen to these comments! ''Wade Boggs: ''What a fabric! Finally we can breathe.'' Luis Palonia: ''Cotton is king.'' Paul O''Neill: ''I never dreamed anything could be so soft and fluffy.'' '),
    ...
    ('They haven''t said anything to you, have they?'),
    ...
    ('They made me buy it... A hundred bucks this thing cost me. How dare they?! I got news for you, if it wasn''t for the toilet, there would be no books.'),
    ...
    ('They? The Government?'),
    ('They took my belt, Jerry. I got nothing to hold my pants up. Well, you gotta come over here now! Just tell ''em what we talked about, how I, how I, I didn''t do the project.'),
    ...
    ('They would never tell me, Elaine. First of all, they probably think that I killed Susan. Besides, I don''t even think they like me.'),
    ('Things are good.'),
    ('Things''ll be great, when you''re'),
    ('Think, a second. You know, your friend was talking about me and, you know'),
    ('Think I''M not?'),
    ...
    ('This friend of Susan''s is staying with us for two weeksNow am I wrong or is that excessive?'),
    ...
    ('This is all blowing up in my face! My serious girlfriend, and my torrid love affair have accidentally crossed paths. I have ruined three lives'),
    ('This is all too much. So what are you feeling? What''s going on? Are you like a couple again now?'),
    ('This is amazing. Thank you. Thank you very much . I''m going back in!  You''ll feel better'),
    ('Thisis an organizer, a secretary, and a friend.'),
    ...
    ('This is great!'),
    ('this is great! He fired her! This is incredible, he fired her. I''m out, baby! I''m out!'),
    ('This is horrible.'),
    ('This is incredible!'),
    ('This is incredible! This is one of the greatest things I''ve ever done in my life! I''m gonna call my mother.'),
    ('This is it! It happened to me, Jerry! I was sitting in the restaurant, the two nut jobs were talking - I couldn''t take it any more. I got up, and  I bop into this woman...'),
    ('This is just what I need.'),
    ('This is like a Penthouse letterWhy can''t I meet women like this?'),
    ...
    ('This is totally different! That was my secret, this is Jerry''s secret! There''sthere''s attorney-client priveleges here! If I play it by your rule, no one''ll ever confide in me again, I''ll be cut out of the loop!'),
    ...
    ('tootsie, good-bye. Too-too, tootsie''  You call this coffee?'),
    ('Top priority.'),
    ('To some degree.'),
    ...
    ('tsh  Ah, yeah, we''ve - we''ve talked  I believe I can speak for the both of us on this.'),
    ('TsssYeah...'),
    ...
    ('(Turning back to Jerry, he takes the check back. He just now notices the shirt Jerry''s wearing, and snickers, pointing) Nice shirt... What is this? Is this what you wore on the show?'),
    ...
    ('Uh, excuse me. Excuse me. This--This is not right. May I? (the guy looks at George with a bothered face. George then walks up to Tom and takes him away from Jerry and Michael to talk to him in private) You wanna hit ''fooled'' more: ''They *fooled* me Jerry!''. You see the difference?'),
    ...
    ('Uh, good. You know, you might wanna try eating it with one of these.'),
    ...
    ('Uhh! I''m caught in my own web of lies!'),
    ('Uh, hi. Uhm, remember me? I..I''m the guy who looks like Neil?'),
    ('Uh-hmm.'),
    ('Uh-huh.'),
    ...
    ('Uh-Huh  Why didn''t she like me?'),
    ('Uh, I just went out, I went to look for my friend?'),
    ('Uh, I''m just selling some of Dad''s things,  that''s what he would have wanted.'),
    ...
    ('UhmI''d like to ask you to analyze a hypothetical phone call, you know, from a female point of view.'),
    ('Uhm, I, I gotta go.'),
    ('Uh, Mrs. Ross? It''s-it''s George.'),
    ('Uh, Mr Wilhelm.'),
    ...
    ('Uh, yeah. Hang on. Just yeah.'),
    ('Uh, yeah, I''ll be there in a minute.'),
    ('Uh, yeah. You know, Doctor, I gotta tell you, I feel a lot better.'),
    ('Uh, yes, actually we-we both do.'),
    ('Uh, yes, uhyou don''t know me, my name is George Costanzadid you happen to rent Breakfast At Tiffany''s?'),
    ('Uhyou know, uhpleasuring you.'),
    ('...Ulterior motive.'),
    ('Um, all right, um, uh, I''ll call ''ya. I''ll call you and we''ll talk on the phone. A telephone communique. Every thing is fine ok, uh, fine, ...'),
    ('Um, cream soda?'),
    ...
    ('Wait a minute, wait a minute. You can''t say anything.'),
    ...
    ('Wait a second, wait a secondand then the butler says, ''I''m not cleanin'' it up! I''m sick of cleaning!'),
    ...
    ('Wait till you hear this! Whoa, ah, I''m sorry, I didn''t, I had no idea.'),
    ('Wait, wait a minutethey don''t have them anymore. I just found out, they just took them off the market.'),
    ...
    ('Wait! Yes! That''s what I should''ve said! D''ohh!'),
    ...
    ('Watch how it''s done. Oh, hello, Mr. Vandelay? Would you like to buy a computer? Oh, really? Two dozen?'),
    ('Watch me.'),
    ...
    ('We bring her to the party, and she can tell me what Gwen is saying about me.'),
    ...
    ('We haven''t heard his notes yet, we don''t know how he feels about our work.'),
    ...
    ('Well, actually you did miss one nugget of entertainment. Have you ever seen Elaine dance?'),
    ...
    ('Well, anything I can do to help, umshe''s a wonderful girl. Very smart. Very ehcrafty.'),
    ...
    ('Well, as I say, the pink-eye made my visionquite blurry'),
    ('We''ll ask him. My dear fellow, where are you dropping us?'),
    ...
    ('Well Dad''s been planning this for such a long time, he bought a new blanket, and he got thathat game with foam paddles and the velcro ball.'),
    ...
    ('Well, Dr, Allenwood, uhI was hoping to compile an - admittedly, rudimentary - scrapbook of her life. Something that Betsy could have, and hold onto.'),
    ...
    ('Well. Gotta motor.'),
    ('Well, Hanke''s moved on to Step Ten. He was spotted taking personal inventory.'),
    ...
    ('Well hello. Um, ah, specifically the reason that I''m here, uh, I don''t know uh what Elaine told you but uh I broke up with my girlfriend a couple of weeks ago. Actually she broke up with me  and uh, well, I was the cause of it and uh, I just wanted to find out from you  What''s with this thing?'),
    ('Well, here we are.'),
    ...
    ('Well, I can''t walk anywhere now. I''m just gonna be wishing there were walkways. What are you doing?'),
    ...
    ('Well, if you must know, shhhe, was my fiance, Susan. May she rest in peace.'),
    ...
    ('Well, I guess these would be out of the question.'),
    ('Well, I have to see her.'),
    ('Well, I heard a noise.'),
    ('Well I-I'),
    ('Well, I, I couldn''t come. I, I had to drive my mother to, to the chiropodist.'),
    ...
    ('WellI''ll ask Susan about it later.'),
    ('Well, I''ll tell you, Stacey. It''s a lot of hard work. But, it comes fairly easy to me. Some people write symphonies. This is my gift.'),
    ...
    ('Well, I''m not buying it. No way. Forget it. No way I''m buying this! I mean, look at it! What is it? It''s a bunch of squiggly lines! Are you telling me you couldn''t paint this?'),
    ('Well I''m not starting up a whole new wardrobe now!!!'),
    ('Well, I''m satisfied. Uhmy back iskilling me.'),
    ('Well, I''m sorry!'),
    ('...Well. I''m sorry. Call you right back.'),
    ('Well, I''m sorry, Timmybut I don''t dip that way.'),
    ...
    ('Well, I think we need more special days at the stadium, you know? Like, uhJoe Pepitone Day. Or, uhJon Voight Day.'),
    ('Well, I think you''re wrong about that. And ah now if you''ll excuse me, I''d really like to get started, please.'),
    ('Well, I think you should drop him down to Step Two.'),
    ('Well, I told it to Susan before, and she didn''t like it.'),
    ('Well, I took the liberty of packing your things. Mom''s coming to get you.'),
    ...
    ('Well it''s not really damaged. 85 dollars huh?'),
    ...
    ('WellI''ve got a lot to do!'),
    ('Well I''ve never met your sister but obviously these are not hard-and-fast rules. Darling, the tea is getting a little cold sweetheart.'),
    ...
    ('WellI was in the locker room showering, and II had to go, so'),
    ('Well I was just going to wander the streets. Don''t wanna tag along with you or anything.'),
    ('Well? I was just - I''m curious, that''s all. We, uh. We''d like you to, do everything possible.'),
    ...
    ('Well let me hear.'),
    ('Well, let me. Heh. Let me just eh... check an'', make sure I have the right man--ha! Heh, heh, heh! Seems--oh! I, oh!'),
    ('Well, let''s just leave.'),
    ('Well, let''s just say it wouldn''t exist without me. ?'),
    ('Well, live and learn.'),
    ('Well, look at this. This doesn''t belong here! Someone has made a terrible mistake.'),
    ('Well, losing a loved is, uhI mean, forget about it.'),
    ('Well, Marisa. See, the thing is I''m sort of engaged.'),
    ('Well, maybe it was Ghostbusters? Where ever it was, it worked!'),
    ('Wellmaybe not as much as this bastard  I can hold my own!'),
    ('Well, maybe not married, but'),
    ('Well, maybe she decided to celebrate her birthday on the Monday after the weekend.'),
    ('Well, maybe sobut it was good enough for Mr. Jon Voight.'),
    ('Well, maybe they''re done with it. I could go pick it up.'),
    ('Well, maybe you could show me something else.'),
    ('Well, me neither.'),
    ('Well Miss Coggins you''re ah, obviously qualified for the job. You''ve all the necessary skills and experience. But you''re extremely attractive. you''re gorgeous. I''m looking at you, I can''t even remember my name. So ah, I''m afraid this is not going to work out  Thanks for coming in.'),
    ('Well, my bed is too small.'),
    ('Well, my father works for the United Volunteers, maybe he can get her one.'),
    ('Well, my mother, Jerry...'),
    ('Well, no.'),
    ('Well no not yet, you gotta buy french stamps  I-I''ll reimburse you of course.'),
    ('Well nothing. I didn''t actually say that.'),
    ('Wellnot ''out.'' She''s a prisoner.'),
    ('Well, not really. After all, she did get together with George Peppard. I mean, Fred.'),
    ('Well, not recently. I craved. I crave all the time, constant cravingbut I haven''t yearned.'),
    ('Well , not yet... Fiance acute.'),
    ('Well now it''s not gonna be original! It''s gonna lose all its cachet!'),
    ...
    ('Well, people never give a good ''hello'' at a funeral. I mean, they go like this  That''s the biggest.'),
    ...
    ('Well, possibly. I wrote an off-Broadway show, ''La Cocina.'' .n.Actually, it was off-off-Broadway. It was a comedy about a Mexican chef.'),
    ('Well, profit. I think you''ll see from the estimate that I''m not really profiting that much. They might be a little high, but...'),
    ...
    ('Well thenthen you really have something to think about because...you know if there''s any doubt in your mind .and... and, it doesn''t even have to be a big doubt, you know even a tiny doubt, a DOT of a doubt... and...'),
    ('Well, there could be.'),
    ('Well there is traffic. It might take her till eight-fifteen.'),
    ('Well, there''s going to be a lot of dentists there.'),
    ('Wellthere''s no room for someone like that in this organization.'),
    ('Well the sex was okay, but I threw up from the Hennigans.'),
    ('Well, they do now. Neighborhood''s changing.'),
    ...
    ('Well why didn''t we?'),
    ('Well, why don''t we just put a monitor in his skybox?'),
    ...
    ('Well, you know, I shouldn''t have let you into Kramer''s, now you want to go into Elaine''sshe entrusted me with her spare keys, how can I just let you in?'),
    ...
    ('Well, you know, I was thinking about what you said before, andyou''re right, I''ve never really been a couple, soif that''s the rule, then I''m gonna go by the rule.'),
    ...
    ('Well you know there is an unusual number of people in this country having sex with AMPUTEES!  Penthouse forum, newspaper, gum, Clark Bar.'),
    ...
    ('Well, you on all fours, that thing vibratin'', kickin'' up sawdust, ho ho! She''ll get the picture!'),
    ...
    ('Well, you see, what happened wasthe doctor - the very same doctor that was attending to my late aunt - suffered an untimely stroke, and lost the use of his right hand, soobviously I was unable to get the death certificate. However, I do have this.'),
    ...
    ('We might have an ''it''!'),
    ('Wemust never ever speak of this again...'),
    ('Wendy? Is that the uh, physical therapist?'),
    ('We need to talk.'),
    ('We ordered the wedding invitations today,, Nothing can stop it now. Nothing. It''s here! It''s happening. Can I do this? I can''t do thisLook at me. Look at me I can''t do this, I can''t do this  Help me Jerry, help me.'),
    ...
    ('We were expecting about two hundred peopleWellThank you , thank you.'),
    ...
    ('What about the letter, should I think about the letter?'),
    ('What about them?'),
    ('What about the mail?'),
    ...
    ('What am I talking about? Come on. You don''t think I bought all that?'),
    ...
    ('Whatare you using my babies now?'),
    ...
    ('Whatever.'),
    ('Whatever. Believe me, if I wasn''t involved right now, I wouldn''t mind being set up. Something tells me she''s a knockout.'),
    ...
    ('What, he can''t jump out of the chair? How long does that take? Here look at this. Here, watch. Criminals. Boom. I''m up. Stop It! Stop It! Stop It!'),
    ('What? He''s outside?'),
    ('What? Huh, so I had it all along. How d''you like that? I guess I owe that cashier an apology.'),
    ...
    ('What? I...I didn''t hear about that.'),
    ...
    ('What is that? It''s ridiculous! You don''t even know what hotel she''s staying at, you can''t call her. That''s a signal, Jerry, that''s a signal! Signal!'),
    ...
    ('What, Minelli''s!?!'),
    ('What? M-Maura, what are you doin'' here? I ended this relationship twice!'),
    ...
    ('What? Oh, My God!'),
    ('What? Oh my God. What? Is it meningitis? Scoliosis? Lupis?! Is it Lupis?!'),
    ...
    ('What''re you kidding me? We were all getting along so well. Where is all this coming from?'),
    ('What''re you talking about?! She''s very concerned! She said she was gonna get it back.'),
    ('what rock?'),
    ('What''s all this?'),
    ...
    ('What''s that.'),
    ('What''s that?'),
    ('What''s the competition, Chitty Chitty Bang Bang?'),
    ...
    ('What''s this? Can''t I leave this place for a second? Can I help you?'),
    ...
    ('What the hell is this? ''George, Elaine and I went to see Chunnel  with Jerry.'' With Jerry, huh? With Jerry! Great. Great! Probably went to the 84th St. That''s where I always go with Jerry.'),
    ('What! There''s no signs here! This is an outrage!'),
    ('What?! They''re stealing the name?! That''s my name, I made it up!'),
    ('What time is it?'),
    ('What time is our flight back? I got to go to the bathroom.'),
    ('What, tonight? Now?'),
    ('What? Too short?'),
    ...
    ('What? Where? Where?'),
    ('What? Wh what''re you talking about? I''m not the one with the problem. Lloyd Braun was in the nuthouse, not me.'),
    ('What? Why?'),
    ('What?! Why?'),
    ...
    ('What, you think I eat all my meals with you? Excuse me, sweetheart? I think you may have overcharged us. What is this?'),
    ...
    ('When are they gonna learn that any news about China is an instant page-turner? What''s that?'),
    ...
    ('Who?'),
    (' Whoa!!'),
    ('Whoait''s like a furnace in here!'),
    ...
    ('Who''s dressing you? You look like a complete idiot! You know, I wouldn''t wipe my- (Unable to take anymore, Leslie gets up and shoves George violently. His hands go straight for the hot iron sitting on the dressing room table. George screams out in agony) AAHHHH!!!!!'),
    ('Whose are these?'),
    ('Whose cane is this?'),
    ...
    ('Wh-what are you talking about? That - that''s rediculous.'),
    ('Wh...what''re you doing here?'),
    ('WhWhere d''you get''em?'),
    ('Wh... Where you going?'),
    ('Why?'),
    ('Why?!'),
    ('Why am I a marine biologist?'),
    ('Why are two pretending to be laughing?'),
    ('Why? Because we''re a team! C''mon! Would you take this for us, dear? Thank you very much. Here we go  Anyone ever tell you you look a lot like Sugar Ray Leonard? Yeah, you must get that all the time.'),
    ('Why?! Because you were stabbed, and... got coffee thrown in your face, and... uh...'),
    ...
    ('Why did it all turn out like this for me? I had so much promise. I was personable, I was bright. I was perceptive. I always know when someone''s uncomfortable at a party.'),
    ...
    ('Why do I do anything? tsssFor women.'),
    ('Why do I get pesto? Why do I think I''ll like it? I keep trying to like it, like I have to like it.'),
    ('Why don''t I rent the movie.'' See, this is when I like you. Alright, now I''m relieved.'),
    ('Why don''t they have salsa on the table?'),
    ('Why don''t we get them a couch? We''ll rent a U-haul -- we''ll bring ''em a nice sectional.'),
    ...
    ('Why not?'),
    ('Why not?!'),
    ('Why not. If she can''t find me, she can''t break up with me. And, if we''re still goin'' out, she has to gooo to the ballll.'),
    ...
    ('Woah. Whoa! Woah!'),
    ('Woah, woah, woah! What are you telling me for? You really had me going, there! C''mon, sit down. What do you want to do when you grow up?'),
    ('Wo-hoah! What did you do?'),
    ('Wohoo, check it out.'),
    ('Women like skiers.'),
    ('Won''t be a problem'),
    ('Won''t work.'),
    ('Woo! Courtside! Is that the best you could do? Ha ha!'),
    ('Woody mentioned me? What did he say?'),
    ('Woooo!'),
    ('Would a giant rubber ball work?'),
    ('Would I have had access to that?'),
    ('Would I like to come up? I would love to come up. I, I''m fighting not to. Fighting! Unfortunately I uh have to get an early start tomorrow. Gotta'' get up and hit that pavement'),
    ...
    ('Would you like a Pepto-Bismol? I keep them in my wallet! Do you think he liked it?'),
    ('Would you mind helping me out with some of this stuff?!?'),
    ('WOULD YOU PICK A STATION!!!!!'),
    ('Would you stop it. Would you quit it please. Someone is going to see us here.'),
    ...
    ('Wow! Heh. You don''t, huh, have a replacement lined up for me, do ya? heh he he he he he'),
    ...
    ('Wow. What''d you say?'),
    ('Wow! Who put this cup right on the new table!'),
    ('Wrath of Khan!'),
    ...
    ('Yeah!, a doodle of melook at the size of the nose , the ears, all my features are distorted.'),
    ('Yeahaha, I gave it a shot  So, any word on the ''artiste''?'),
    ...
    ('Yeah, but you - you promised it to me.'),
    ('Yeah, come on.'),
    ('Yeah, conjugal visit sex. That is happening!'),
    ('Yeah. Cotton breathes, you see, it''s much softer. Imagine playing games and your team is five degrees cooler than the other team. Don''t you think that would be an advantage? They''re cooler, they''re more comfortablethey''re happier - they''re gonna play better.'),
    ('Yeah, coy.'),
    ('Yeah, Cubans.'),
    ('Yeah,  Definite smoke.'),
    ('Yeah, dentist of the stars.'),
    ('Yeah. Did you do it?'),
    ('Yeah, doctor. I''m going to have to wait in that little room all by myself, aren''t I? I better take this. I hate the little room. ''Oh, hello, Doctor.'),
    ...
    ('Yeah, good night.'),
    ('Yeah. Good weekend.'),
    ('Yeah. Got to invite The Drake. Listen hemthere''s something that''s been on my mind and we haven''t really talked about it...I t''s kind of important to me.'),
    ...
    ('Yeah. I did some shopping. Some new clothes shopping. Can I borrow your menu?'),
    ...
    ('Yeah, I got one too.'),
    ('yeah I got some sandwiches... I got tuna... and salmon salad Tony because I know you don''t like peanut butter'),
    ...
    ('Yeah, I know that. Could you start, working?'),
    ...
    ('Yeah, I may move out there. I mean it, I''ll do it! OK, I''ll see ya later. Keep it real!'),
    ('Yeah. I''m Buck Naked.'),
    ...
    ('Yeah, it''s being framed right now. I don''t even know what it costs. Not, uh, too expensive, is it?'),
    ('Yeah, it''s bizarre.'),
    ('Yeah, it''s George.'),
    ...
    ('Yeah, like I''m going to risk my job with the New York Yankees to make a few extra bucks.'),
    ('Yeah, like that.'),
    ...
    ('Yeah. No, no, no, wait a minute, I always have tuna on toast. Nothing''s ever worked out for me with tuna on toast. I want the complete opposite of on toast. Chicken salad, on rye, un-toasted with a side of potato salad  and a cup of tea.'),
    ...
    ('Yeah. Not that I care, one way or the other, but these doctors today really do amazing things, you know, if you were so inclined. And again, I''m not suggesting.'),
    ('Yeah, now I gotcha!'),
    ...
    ('Yeah. Oh, you think because of what I said about the manure. I wa, wa, was just saying how it takes a negative thing, and puts it on a positive spin on it.'),
    ('Yeah, okay.'),
    ...
    ('Yeah, phew.'),
    ('Yeah. (Points to two open seats in front of Jerry''s. To Nina) Sit down there. Hello, Jerry. I believe you know Nina.'),
    ...
    ('Yeah, right I''m gonna get my car repaired at a dealership. Huh! Why don''t I just flush my money down the toilet?'),
    ...
    ('Yeah, sure.'),
    ('Yeah, sure. I was showing a condo on 48th street. Besides, you think I wanna miss this?'),
    ('Yeah, Sure, sure ,,, I got to drop my car off at the new lot.'),
    ('Yeah, sure. Then my father will have no place to sleep. He''s gotta move out.'),
    ...
    ('Yeah! That''s how they talk. You know, everyone''s either a bastard or a son of a bitch. Yeah, it''s like uh''boy, that son of a bitch Box can really hit, uh?!'),
    ('Yeah, that''s right.'),
    ('yeah that''s right. I like it. He''s such a cool guy'),
    ('Yeah, that''s right. It''s working.'),
    ('Yeah, that''s right. What if it''s a genetic thing, like father like son?'),
    ...
    ('Yeah. The thing is, I, uhI had this little zinger of my own I wanted to try.'),
    ...
    ('Yeah. Uhm, why did she die so young?'),
    ('Yeah, uh, no menus.'),
    ('yeah. Uh, oh, here''s your sunglasses.'),
    ('Yeah, well.'),
    ('Yeah, wella little rough finding something good in your price-range. But you, my friend, may be in luck.'),
    ...
    ('Yeah! Yeah. Hey--hey you, you know... Maybe I''ll call you sometime.'),
    ('Yeah, yeah. I have a thing for Marisa Tomei. Like she would ever go out with a short, stocky, bald man. Hu hu, ha ha. Like that''s her type. Huh. She''s an Oscar winner. He heh. Besides, I don''t even know her. It''s not like anyone''s trying to fix us up. Who, who would try and fix me up with Marisa Tomei?'),
    ('Yeah. yeah. I-I know.'),
    ('Yeah,yeah!! I''ll pick you up right now...All right All right.Hey! gotta go.'),
    ('Yeah, yeah. I''m gonna move in with him. He doesn''t even let you use the toilet!'),
    ...
    ('Yeah, yeah, like it''s just part of the conversation. ''Oh my boyfriend really likes watches. He''s a real watch freak.'' We-e-ell that''s fabulous.'),
    ...
    ('Yeah. Yeah. You know the odds of me being anyone''s type?! I have never been anyone''s type, but apparently, this Marisa Tomei loves funny, quirky, bald men.'),
    ...
    ('Yeah. You get a couch. I get rid of my father. It couldn''t be more perfect!'),
    ...
    ('Yeah, you''re right, you''re right. Alright, maybe he''s not interested, but you still know him - can''t you just ask him?'),
    ('Yeah, your milk.'),
    ('Yeah, you said it. Uh, excuse me, Mr Wilhelm. Uh, do you really think Well, is this downtown trip really necessary, you know, for the project?'),
    ...
    ('Yes! God, I''ve never felt so alive!'),
    ('Yes, good for me!'),
    ...
    ('Yes I''d like to speak to Marisa Tomei, please? Marisa, Hi it''s George Costanza... I''m the short, funny, quirky bald man you met a little while ago, heh! yeah I was just calling ''cos I wanted you to know that I''m not engaged anymorewell huh, She died.Toxic glue from the wedding invitations...well we were expecting about two hundred people. Yeah Anyway... hum I got the funeral tomorrow but huh... my weekend is pretty wide open and I was wondering ... HelloHello...'),
    ('Yes I do.'),
    ...
    ('Yes, In fact, her mother is in the hospital right now. It''s some kind of a Diverticulitis.'),
    ...
    ('Yes. Live, dammit. Live! Every precious moment as if this was the last year of your life. Because in many waysit is. Excuse me.'),
    ...
    ('Yes, payroll. Yes I did. Very productive. Payroll Paid off.'),
    ('Yes, please.'),
    ...
    ('Yesterday, took the day off. Now, from the time I left the room'),
    ...
    ('Yes, well, I sat down with Mr. Steinbrenner. I told him you have been doing great work. I said that you deserved a raise, and if you didn''t get it, that I, was leaving.'),
    ...
    ('Yes. Yes, it''s white. Why it''s white.'),
    ...
    ('Yes. Yes. You know what''s interesting. The quarterback for the Atlanta Falcons is Bobby Hebert. No ''r'' which I find fascinating. You know it''s Herbert h-e-r-b-e-r-t, Hebert h-e-b-e-r-t. ''Hebert'' it''s a fun name to pronounce. Try and say it Hebert. Take a shot. All right. All right. I'),
    ('Yes you did!'),
    ...
    ('yodel lay hee hoo...'),
    ('Yoohoo ,PlentyWh...wh...what are doing humyou''re going in?'),
    ('You'),
    ('You?'),
    ('You almost did the nose.'),
    ('You already got it.'),
    ('You already have an in. You have the same first name!  ''Jerry''!'),
    ...
    ('You can''t be serious. This is New York city. There must be eleven million decent hotel rooms! Whatta you need? A flag? This is the signal, Jerry, this is the signal!'),
    ...
    ('You can''t handle the truth! (imitating Jack Nicholson [a.k.a. Col. Nathan R. Jessep], from the 1992 movie A Few Good Men)'),
    ...
    ('You can''t tell much from those pictures.'),
    ('You caved?!'),
    ...
    ('You did?'),
    ('You did all thisfor a pinky toe?'),
    ('You didn''t?'),
    ('You didn''t ask him?'),
    ...
    ('You don''t need the cufflinks! You have the same name! ''Jerry''!'),
    ('You don''t remember me?'),
    ('You don''t speak *any* English?'),
    ('You don''t tell him?'),
    ('You don''t think I can?'),
    ('You don''t think I can keep a secret?'),
    ('You don''t think you can buy the ticket yourself? No, there, thereyou sit, and I''ll purchase the ticket for you.'),
    ('You don''t tip a gardener!'),
    ('You don''t trust my poker face?'),
    ('You don''t understand. A garage. I can''t even pull in there. It''s like going to a prostitute. Why should I pay, when if I apply myself, maybe I could get it for free? What? What do you want? Go around me, I''m looking for spaces.'),
    ...
    ('You, I guess, you don''t remember me... but we actually, kind of um... went out... a couple of years ago... once... remember?'),
    ...
    ('You know, about the uh, two of us getting together. And I know that I said I was engaged, but  uh, you know, it''s really just something you say. It''s like, going steady. You know uh, going steady, engaged, it''s, it''s all just stuff you say. Anyway, I was watching uh, My Cousin Vinnie, on the uh, on the tape the other day, and I was thinking that uh, you know, the two of us might take a meeting, as they say. So, what d''you, what d''you think?'),
    ...
    ('You know, Hawaii could be a little tricky right now, there''s a lot of high pressure winds down there this time of year, there''s a lot of debris constantly flying around. Wood, and uh, lava, pretty dangerous.'),
    ('You know her name?'),
    ('You know honey for an unadvertised sale, you''re doing a lot of yapping about it.'),
    ...
    ('You know if I told my engagement story to that receptionist, but told her this, was my fiance...'),
    ('You know, if it was a regular salad I wouldn''t have said anything. But you had to have the BIG SALAD.'),
    ('You know, I got nothing outta this!'),
    ('You know, I got this little swelling right here. It''s kinda painful. What d''you make of it?'),
    ...
    ('You know, I''m sorry, II hate to be one of those people, but we''re right in the middle of this thingI can''t hear.'),
    ('You know, I''m starting to get a little nervous about this lunch.'),
    ...
    ('You know, I used to love Paris. My uh, dead Fiance, Susan... In fact I. think I, I may have a picture of her...'),
    ...
    ('You know, Lloyd, I-I''ve been to the doctor  there''s really nothing they can do.'),
    ...
    ('You know, sometimes those guys don''t make it back. I''m really hungry.'),
    ...
    ('You know, the thing is, I kinda promised the widow Mantle that I would name my baby Seven.'),
    ('You know, the time...'),
    ('You know, the uh'),
    ...
    ('You know those shoes that Jimmy had? I cut a deal with him. We''re gonna import a case of them together.'),
    ...
    ('You know we should really order, the service is so slow here, by the time you get anything'),
    ...
    ('You know what. I don''t think I''m going to be able to stay over tonight.'),
    ('You know what, I''ll just uh, I''ll just look around for a little while. I''ll just browse around.'),
    ...
    ('You know what? I should really go talk to her. Nothing confrontational. Just two adults sitting down trying to clear the air. You know, I just know if I could spend some time alone with her. I''ve got to. I''ve got to.'),
    ...
    ('You know what? it''s better than Elaine''s, too. I gotta give her a call.'),
    ('You know what, I urge you to take it up with him. Go ahead, give him a call, he''ll tell you what I''m doing here. Then you can tell me.'),
    ...
    ('You know, when I was a kid, I once found a dollar and fifty cents in change on the bottom of the pool.'),
    ...
    ('You know, you''re going along, you think everything''s all right and all of a sudden you get that tap. . You know it''s like pfffff , all right that''s enough, you''re through.'),
    ('You know, you''re nuts with these sponges. George is gettin'' frustrated!'),
    ('You know, you''re really being very selfish. It would be nice if you would think of someone other than yourself every now and then!'),
    ('You know. You use the, uh'),
    ('You lie! How hard is it to lie?!'),
    ('You like ice?'),
    ('You like that?'),
    ('You''ll do it?'),
    ('You''ll have your turn! The truth must be heard. That''s all there was. And yet, it speaks volumes. A low rumple. A metallic ''squink.'' A ''glonk.'' Someone crying out''Dear God!'' Let''s start with, uhwith you, Wyck.'),
    ...
    ('You might want to try itmakes the movie more enjoyable, that''s all.'),
    ('You miss her.'),
    ('You miss her, don''t you?'),
    ('You must be very proud Mr. Visaki. And may I say sir they''re lovely girls, absolutely lovely girls. It''s nice to see such fine upstanding women in gainful employment, Mr. Visaki.'),
    ('You must hate hot dogs, huh? Or else, you, uh, you really like ''em and that''s why you, you do this.'),
    ('You nervous?'),
    ...
    ('You open the door to the car, boom, you walk right into the hospital. Eh, You can''t beat that spot. I am on a roll. I''m just willing these great parking spots.'),
    ...
    ('You''re fresh  You''re very fresh. You seem very fresh to me. You''re very vital. I couldn''t take you any fresher.'),
    ...
    ('You''re right, how did I miss that? Maybe because it''s a crock of shit.'),
    ...
    ('You see this is the thing . I just feel  mumble, cry, mumble,  I''m scared. You and I together,'),
    ...
    ('You see? We were made for each other. It''s amazing. If I reach out and touch her breast right not, she''d scream and throw me out of the car. But at this time tomorrow, I could touch it all I want.'),
    ('You see...WHAT!!'),
    ...
    ('You see . You see. You see what I''m talking about. It''s all just slipping away. And you''re letting it happen.'),
    ('You sell them?'),
    ...
    ('You tellin'' ''em about the butler story? Is that beautiful or what? Hey, sorry I''m late. Russell?'),
    ...
    ('You think you''re going to the other side with ''Hi''? You''re not going to make it.'),
    ('You think your parents would have any objections to taking a little kid to Paris with them? It turns out that the kid''s father lives in Paris. Is that a coincidence?'),
    ('You thought she was good looking, right?'),
    ('You told David Putty your move and you didn''t tell *me*? I *need* a move. You know I have no moves, Jerry. Gimme a bite.'),
    ...
    ('You''ve still got pretty good coverage. Once the enemy advances beyond this perimeter -  - then you won''t be Kurt anymore.'),
    ('You vomited in 1987.'),
    ('You wanna see?! There! There it is! Alright, here! You wanna try on the hat?! Here! Try on the hat!'),
    ('You wanna sell computers? I will show *you* how to sell computers! Hello, Mr. Farneman. You wanna buy a computer? No? Why not? All right, I see! Good answer! Thank you! Serenity now!'),
    ...
    ('You yearn.'),
    ('You-you sure you never slept with her? Perfect.'),
